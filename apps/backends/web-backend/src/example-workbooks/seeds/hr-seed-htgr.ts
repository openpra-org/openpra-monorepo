...
const routineActivities = [
  ...
  { id: "RA-6", name: "RCCS duct-damper alignment", activityType: "CALIBRATION" as const, description: "Alignment check and calibration of the reactor cavity cooling system duct dampers across the three passive cooling ducts by one crew.", sources: ["PROCEDURES", "INDUSTRY_EXPERIENCE"], systems: ["SYS-RCCS"], components: ["Duct 1 to 3 dampers"], states: ["POS-01"], multiTrain: true, mechanism: "One crew on a common alignment procedure across the three passive cooling ducts.", preOp: "Taken from the draft RCCS surveillance procedure and the passive-cooling design, to be confirmed against operation.", srs: ["HR-A3", "HR-A5"] },
...
const preInitiatorScreeningRecords = [
  ...
  { id: "PS-6", activityId: "RA-6", screenedOut: false, justification: "Common alignment across the three passive cooling ducts is multi-train, so it may not be screened out.", srs: ["HR-B1", "HR-B3"] },
...
const preHfes: HumanFailureEvent[] = [
  ...
  { id: "HR-PRE-018", name: "RCCS duct-damper misalignment", source: "RA-6", impact: "SYSTEM", systems: ["SYS-RCCS"], components: ["Duct 1 to 3 dampers"], states: ["POS-01"], detect: 2160, basis: "Error sits until the next quarterly RCCS surveillance.", modes: ["Reduced passive-cooling duct flow across the ducts"], miscal: true, note: "Common misalignment of the three passive cooling ducts from one crew on one procedure, degrading the passive backstop.", srs: ["HR-C1", "HR-C2", "HR-C5"] },
