...
export const IE_ANALYSIS: InitiatingEventsAnalysis = {
  ...
  conformanceMatrix: [
    ...
    cm("IE-C11", "C", "MET",            BOTH, "IE-15 fault-tree model documented with quantifiesFrequencyNotProbability flag set; top event is frequency per plant-year."),
    cm("IE-C12", "C", "MET",            BOTH, "HFE contributions excluded from IE-15 fault tree with documented basis; operator contribution addressed separately in IE-18."),
    cm("IE-C13", "C", "MET",            BOTH, "Operator split fraction estimated for IE-18 (drain-down); 5% operator / 95% hardware, conservative pre-op basis."),
    cm("IE-C14", "C", "MET",            BOTH, "Recovery action credited in IE-18 quantification with documented justification per IE-C14."),
    cm("IE-C15", "C", "PARTIAL",        BOTH, "Plant-specific recovery information not yet available pre-operationally; conservative pre-op estimate used for IE-18."),
    cm("IE-C16", "C", "MET",            BOTH, "Rare-event treatment documented for IEG-LOFA: expert-judgment-based lognormal; IE-09 uses order-of-magnitude engineering bound."),
    cm("IE-C17", "C", "MET",            BOTH, "Generic-data comparison performed for IEG-TRANS; no frequency adjustment required (confirmed IE-FREQ-01)."),
    cm("IE-C18", "C", "PARTIAL",        BOTH, "Uncertainty characterised for 8 of 9 quantifications; IEG-LOFA probabilistic representation still pending."),
    cm("IE-C19", "C", "MET",            BOTH, "Component failure combinations included in IE-15 fault-tree model (componentFailureCombinationsIncluded = true)."),
