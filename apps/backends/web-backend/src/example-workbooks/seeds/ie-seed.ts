...
const HAZOP_MODEL: HazardOperabilityStudy = {
  uuid: "HAZOP-HTGR-1",
  name: "Generic HTGR coupled-system HAZOP",
  methodKind: "HAZARD_OPERABILITY_STUDY",
  analyst: "Aakash Patel",
  supportingDocuments: ["IEC 61882 (HAZOP)", "NEI 18-04 / RG 1.233"],
  deviations: [
    { id: "HZ-1", node: "Power-conversion line (turbine, condenser)", parameter: "Load / heat sink", guideword: "NO", deviation: "Turbine trip or generator load rejection removes the normal heat sink", causes: ["Turbine or generator protective trip", "Grid load rejection", "Main-condenser isolation"], consequence: "Loss of the normal power-conversion heat sink; primary helium temperature rises and the reactor trips", safeguards: ["Reactor protection scram on high helium temperature", "SCS and passive RCCS decay-heat removal"], derivedInitiatorIds: ["IE-05"] },
    { id: "HZ-2", node: "Primary helium loop (temperature-reactivity coupling)", parameter: "Temperature", guideword: "LESS", deviation: "Sudden rise in primary heat-removal rate overcools the core", causes: ["Step increase in feedwater or secondary cooling", "Rapid circulator speed-up"], consequence: "Positive reactivity inserted through the negative temperature coefficient; core power rises", safeguards: ["High-flux RPS trip", "Large negative temperature coefficient bounds the excursion"], derivedInitiatorIds: ["IE-11"] },
    { id: "HZ-3", node: "Helium coolant chemistry / purification loop", parameter: "Composition (moisture, oxidants)", guideword: "MORE", deviation: "Rising coolant impurity from loss of purification", causes: ["Failure or bypass of a purification train (copper-oxide bed, molecular sieve, low-temperature adsorber)", "Isolation of the purification loop"], consequence: "Coolant moisture and oxidant rise, threatening chemical attack on the graphite and fuel over time", safeguards: ["Coolant moisture and impurity monitoring", "Redundant purification trains", "Moisture-ingress limits"], derivedInitiatorIds: ["IE-35"] },
    { id: "HZ-4", node: "Reactivity control / startup line-up", parameter: "Reactivity", guideword: "MORE", deviation: "Erroneous reserve-shutdown or control-rod mis-positioning during startup", causes: ["Operator startup line-up error", "Reserve-shutdown equipment mis-set"], consequence: "Unplanned positive reactivity during startup with a short reactor period", safeguards: ["Startup-range high-flux and short-period RPS trips", "Procedural rod-worth checks and independent verification"], derivedInitiatorIds: ["IE-42"] },
    { id: "HZ-5", node: "Primary pressure boundary / maintenance line-up", parameter: "Pressure", guideword: "LESS", deviation: "Inadvertent vent or relief-valve opening during maintenance depressurizes the primary", causes: ["Operator opens a vent or relief path", "Maintenance mis-alignment of an isolation valve"], consequence: "Primary helium depressurization and loss of boundary integrity in a maintenance state", safeguards: ["Low-pressure RPS trip", "Interlocks on the vent and relief alignment", "Independent verification of the line-up"], derivedInitiatorIds: ["IE-43"] },
    { id: "HZ-6", node: "Secondary heat-removal line", parameter: "Flow", guideword: "MORE", deviation: "Erroneous secondary or heat-removal maneuver overcools the primary", causes: ["Operator feedwater or secondary control error"], consequence: "Overcooling drives positive reactivity through the temperature feedback", safeguards: ["High-flux RPS trip", "Negative temperature coefficient", "Procedural secondary-maneuver limits"], derivedInitiatorIds: ["IE-45"] },
    { id: "HZ-7", node: "Helium coolant chemistry / purification loop", parameter: "Flow", guideword: "REVERSE", deviation: "Reverse flow in a purification line", causes: ["Blower or compressor trip in the purification loop"], consequence: "Local chemistry transient bounded by the redundant trains; no plant-level initiator", safeguards: ["Check valves", "Redundant purification trains"], derivedInitiatorIds: [] },
    { id: "HZ-8", node: "Helium inventory / pressure-control loop", parameter: "Pressure", guideword: "MORE", deviation: "Slow pressure rise from helium makeup mis-control", causes: ["Inventory-control set-point error"], consequence: "Bounded by the relief provisions; no initiator beyond the identified depressurization set", safeguards: ["Primary pressure relief", "Inventory-control alarms"], derivedInitiatorIds: [] },
  ],
};

const PHA_MODEL: ProcessHazardAnalysis = {
  uuid: "PHA-HTGR-1",
  name: "Generic HTGR process hazard analysis",
  methodKind: "PROCESS_HAZARD_ANALYSIS",
  analyst: "Aakash Patel",
  supportingDocuments: ["NEI 18-04 / RG 1.233", "ASME/ANS RA-S-1.4 IE-A1"],
  scope: "Early-design process hazard analysis that frames and reconciles the component-level FMEA and the deviation-level HAZOP across the Generic HTGR. Each hazard topic is checked for consistent coverage by both sweeps, gaps are closed, and the resulting initiators are accepted into the IE-A5 spectrum.",
  reconciledFmeaIds: ["FMEA-HTGR-1"],
  reconciledHazopIds: ["HAZOP-HTGR-1"],
  reconciliationItems: [
    { id: "PHA-1", topic: "Loss of forced cooling", fmeaCoverage: "FMEA of the circulator and heat-transport train (circulator trip, bearing or seal failure) yields the pressurized loss-of-forced-cooling initiators", hazopCoverage: "HAZOP of the power-conversion line yields the turbine-trip and loss-of-heat-sink path", resolution: "Both retained as distinct initiators: forced-flow loss (circulator) versus heat-sink loss (turbine and steam generator)", derivedInitiatorIds: ["IE-01", "IE-05"] },
    { id: "PHA-2", topic: "Reactivity from overcooling", fmeaCoverage: "The component-level FMEA does not capture the temperature-to-reactivity coupling", hazopCoverage: "HAZOP of the primary-loop temperature deviation captures the overcooling-driven positive reactivity", resolution: "Gap closed by the HAZOP; overcooling reactivity retained as IE-11, bounded by the negative temperature coefficient", derivedInitiatorIds: ["IE-11"] },
    { id: "PHA-3", topic: "Coolant chemistry and moisture", fmeaCoverage: "FMEA of the helium purification trains finds the loss-of-purification failure modes", hazopCoverage: "HAZOP of the coolant-chemistry node finds the rising-impurity deviation", resolution: "Reconciled to a single loss-of-coolant-chemistry-control initiator", derivedInitiatorIds: ["IE-35"] },
    { id: "PHA-4", topic: "Operator-induced boundary and reactivity errors", fmeaCoverage: "FMEA covers the operator-interface components", hazopCoverage: "HAZOP guidewords on the maintenance and startup line-ups surface the human-failure deviations", resolution: "Human-failure initiators (erroneous depressurization, rod mis-positioning, overcooling) retained from the HAZOP sweep", derivedInitiatorIds: ["IE-42", "IE-43", "IE-45"] },
    { id: "PHA-5", topic: "Xenon spatial reactivity", fmeaCoverage: "Not a component failure, so no FMEA row applies", hazopCoverage: "Not a single-line process deviation, so no HAZOP row applies", resolution: "Found directly by the PHA review of core reactivity behaviour; retained as IE-10 and bounded by the negative temperature feedback", derivedInitiatorIds: ["IE-10"] },
  ],
  directInitiatorIds: ["IE-10"],
};

const OEREV_MODEL: OperatingExperienceReview = {
  uuid: "OEREV-HTGR-1",
  name: "Generic HTGR operating-experience review",
  methodKind: "OPERATING_EXPERIENCE_REVIEW",
  analyst: "Aakash Patel",
  supportingDocuments: ["ASME/ANS RA-S-1.4 IE-A8, IE-A11, IE-A14", "NUREG/CR-6839 Fort St. Vrain operational experience", "IAEA-TECDOC-978 gas-cooled reactor operating experience"],
  sources: [
    { id: "OE-FSV", name: "Fort St. Vrain HTGR (USA)", type: "Prototype prismatic HTGR", period: "1976-1989", eventsReviewed: 6, applicability: "HIGH", note: "Closest analogue: prismatic, helium-cooled, steam-cycle plant with water-lubricated circulator bearings. Water-ingress and circulator precursors map directly." },
    { id: "OE-AVR", name: "AVR pebble-bed reactor (Julich, Germany)", type: "Prototype pebble-bed HTR", period: "1967-1988", eventsReviewed: 5, applicability: "MEDIUM", note: "Helium-cooled but pebble-bed. The 1978 steam-generator water ingress and the late-discovered high core temperatures apply; pebble fuel handling does not." },
    { id: "OE-THTR", name: "THTR-300 pebble-bed reactor (Germany)", type: "Prototype pebble-bed HTR", period: "1985-1989", eventsReviewed: 4, applicability: "SCREENED", note: "Pebble-specific fuel breakage, pebble circulation and fuel-feed events do not apply to the prismatic block core. Reviewed for completeness; reactivity-control and availability lessons noted." },
    { id: "OE-PB1", name: "Peach Bottom Unit 1 HTGR (USA)", type: "Prototype prismatic HTGR", period: "1967-1974", eventsReviewed: 3, applicability: "MEDIUM", note: "Prismatic-core prototype. Fuel-barrier performance and primary-coolant impurity (oil ingress) precursors are relevant." },
    { id: "OE-DRAGON", name: "Dragon reactor (UK / OECD)", type: "Experimental HTGR", period: "1965-1976", eventsReviewed: 3, applicability: "MEDIUM", note: "Experimental helium-cooled reactor. Primary-boundary helium leakage, purification-line corrosion and circulator gas-bearing behaviour are relevant." },
    { id: "OE-TEST", name: "HTTR (Japan) and HTR-10 (China) test reactors", type: "HTGR safety-demonstration test reactors", period: "1998-present", eventsReviewed: 5, applicability: "MEDIUM", note: "Loss-of-forced-cooling and control-rod-withdrawal safety-demonstration tests (several as ATWS) confirm the passive response and bound the LOFC and reactivity initiators." },
  ],
  precursors: [
    { id: "PR-1", event: "Chronic helium-circulator water-lubricated bearing/seal water ingress into the primary coolant, recurring through plant life and the main cause of poor availability", sourceId: "OE-FSV", date: "1976-1989", derivedInitiatorIds: ["IE-23"], disposition: "RETAINED" },
    { id: "PR-2", event: "23 June 1984 circulator trip with loss of bearing-water supply, over 300 gallons of water ingress (primary moisture above 100 ppm), and a scram with several control-rod pairs failing to fully insert", sourceId: "OE-FSV", date: "1984-06", derivedInitiatorIds: ["IE-23"], disposition: "RETAINED" },
    { id: "PR-3", event: "Core and region-outlet helium temperature fluctuations (first of 37 events) from core-component movement with bypass and crossflow changes, resolved with region constraint devices", sourceId: "OE-FSV", date: "1977-10", derivedInitiatorIds: ["IE-14"], disposition: "GROUPED" },
    { id: "PR-4", event: "Reserve-shutdown-system degradation from primary moisture following the water ingress (diverse shutdown path affected)", sourceId: "OE-FSV", date: "1984", derivedInitiatorIds: [], disposition: "OPEN" },
    { id: "PR-5", event: "August 1989 stuck control-rod pair and steam-generator ringheader cracks contributing to the permanent-shutdown decision", sourceId: "OE-FSV", date: "1989-08", derivedInitiatorIds: ["IE-09"], disposition: "GROUPED" },
    { id: "PR-26", event: "First documented steam-generator tube leak admitting moisture into the primary helium (slow, monitor-detected)", sourceId: "OE-FSV", date: "1977-11", derivedInitiatorIds: ["IE-20"], disposition: "RETAINED" },
    { id: "PR-6", event: "1978 steam-generator leak admitting water and steam into the primary helium circuit", sourceId: "OE-AVR", date: "1978", derivedInitiatorIds: ["IE-21"], disposition: "RETAINED" },
    { id: "PR-7", event: "Late discovery, by melt-wire monitors, of core and fuel temperatures far above design from excessive bypass flow", sourceId: "OE-AVR", date: "1986", derivedInitiatorIds: ["IE-14"], disposition: "GROUPED" },
    { id: "PR-8", event: "Operators delayed or bypassed an emergency shutdown action during the 1978 water-ingress event", sourceId: "OE-AVR", date: "1978", derivedInitiatorIds: [], disposition: "OPEN" },
    { id: "PR-9", event: "Degraded coated-particle fuel performance and elevated fission-product release during operation", sourceId: "OE-AVR", date: "1986", derivedInitiatorIds: [], disposition: "SCREENED" },
    { id: "PR-10", event: "Heavy primary-circuit and reactor-vessel contamination by metallic fission products (caesium, strontium)", sourceId: "OE-AVR", date: "1988", derivedInitiatorIds: [], disposition: "SCREENED" },
    { id: "PR-11", event: "Spherical fuel elements breaking and fragmenting more often than designed, generating graphite dust", sourceId: "OE-THTR", date: "1986", derivedInitiatorIds: [], disposition: "SCREENED" },
    { id: "PR-12", event: "Control and absorber rods driven into the pebble bed damaging fuel spheres", sourceId: "OE-THTR", date: "1986", derivedInitiatorIds: [], disposition: "SCREENED" },
    { id: "PR-13", event: "4 May 1986 fuel-feed blockage and small radioactive release during pebble handling", sourceId: "OE-THTR", date: "1986-05", derivedInitiatorIds: [], disposition: "SCREENED" },
    { id: "PR-14", event: "Early permanent shutdown (1989) after high disturbance frequency and low availability for a first-of-a-kind plant", sourceId: "OE-THTR", date: "1989-09", derivedInitiatorIds: [], disposition: "SCREENED" },
    { id: "PR-15", event: "Core 1 mass fuel-element failure (90 elements with cracked sleeves) and progressively rising primary-coolant radioactivity", sourceId: "OE-PB1", date: "1968", derivedInitiatorIds: [], disposition: "SCREENED" },
    { id: "PR-16", event: "Primary-circuit oil ingress of about 100 kg from the main helium compressor, upsetting coolant chemistry", sourceId: "OE-PB1", date: "1969", derivedInitiatorIds: ["IE-35"], disposition: "GROUPED" },
    { id: "PR-17", event: "Moisture-monitor instrumentation failure during the oil-ingress chemistry upset", sourceId: "OE-PB1", date: "1969", derivedInitiatorIds: [], disposition: "SCREENED" },
    { id: "PR-18", event: "Helium-purification piping leaks from chloride (PVC-tape) corrosion on the primary-cleanup loop", sourceId: "OE-DRAGON", date: "1970", derivedInitiatorIds: ["IE-36"], disposition: "GROUPED" },
    { id: "PR-19", event: "Chronic primary-circuit helium leakage above design through instrument penetrations", sourceId: "OE-DRAGON", date: "1970", derivedInitiatorIds: ["IE-15"], disposition: "GROUPED" },
    { id: "PR-20", event: "Circulator gas-bearing dry-friction damage risk at low rotational speed during transients", sourceId: "OE-DRAGON", date: "1972", derivedInitiatorIds: ["IE-01"], disposition: "GROUPED" },
    { id: "PR-21", event: "Loss-of-forced-cooling demonstration test: all three primary helium circulators tripped, confirming passive decay-heat removal", sourceId: "OE-TEST", date: "2010-12", derivedInitiatorIds: ["IE-01"], disposition: "RETAINED" },
    { id: "PR-22", event: "Loss-of-core-cooling demonstration test (circulator trip with degraded vessel cooling)", sourceId: "OE-TEST", date: "2011-01", derivedInitiatorIds: ["IE-14"], disposition: "GROUPED" },
    { id: "PR-23", event: "Reactivity-insertion (control-rod-withdrawal) safety-demonstration test", sourceId: "OE-TEST", date: "2002", derivedInitiatorIds: ["IE-08"], disposition: "GROUPED" },
    { id: "PR-24", event: "Helium-circulator-trip ATWS demonstration test (blower stopped without scram)", sourceId: "OE-TEST", date: "2003-10", derivedInitiatorIds: ["IE-01"], disposition: "GROUPED" },
    { id: "PR-25", event: "Control-rod-withdrawal reactivity-insertion ATWS demonstration test", sourceId: "OE-TEST", date: "2003-11", derivedInitiatorIds: ["IE-08"], disposition: "GROUPED" },
  ],
};

const GENLIST_MODEL: GenericInitiatorCatalogue = {
  uuid: "GENLIST-HTGR-1",
  name: "Generic initiator catalogue (NUREG/CR-5750) screened for the HTGR",
  methodKind: "GENERIC_INITIATOR_CATALOGUE",
  analyst: "Aakash Patel",
  supportingDocuments: ["NUREG/CR-5750 Rates of Initiating Events at US Nuclear Power Plants", "EPRI initiating-event catalogues"],
  entries: [
    { id: "GI-01", name: "Loss of offsite power (LOOP)", source: "NUREG/CR-5750", applicable: true, derivedInitiatorIds: ["IE-28"], rationale: "The plant has a switchyard and onsite AC distribution, so a grid loss trips the forced-cooling prime movers." },
    { id: "GI-02", name: "Total loss of main feedwater", source: "NUREG/CR-5750", applicable: true, derivedInitiatorIds: ["IE-03"], rationale: "Steam-cycle plant with a helium-to-water steam generator fed by a feedwater system." },
    { id: "GI-03", name: "Partial loss of feedwater", source: "NUREG/CR-5750", applicable: true, derivedInitiatorIds: ["IE-03"], rationale: "Multi-pump feedwater system; partial loss grouped under the loss-of-feedwater initiator." },
    { id: "GI-04", name: "Turbine trip", source: "NUREG/CR-5750", applicable: true, derivedInitiatorIds: ["IE-05"], rationale: "Rankine secondary loop with a steam turbine-generator." },
    { id: "GI-05", name: "General / unplanned reactor transient trip", source: "NUREG/CR-5750", applicable: true, derivedInitiatorIds: ["IE-07"], rationale: "The reactor scrams on control rods, so the general-transient-trip catch-all applies." },
    { id: "GI-06", name: "Loss of condenser heat sink / vacuum", source: "NUREG/CR-5750", applicable: true, derivedInitiatorIds: ["IE-02"], rationale: "The Rankine secondary loop has a main condenser and vacuum system." },
    { id: "GI-07", name: "Main steam isolation valve closure", source: "NUREG/CR-5750", applicable: true, derivedInitiatorIds: ["IE-02"], rationale: "Main steam lines from the steam generator have isolation valves; closure isolates the heat sink." },
    { id: "GI-08", name: "Steam generator tube rupture", source: "NUREG/CR-5750", applicable: true, derivedInitiatorIds: ["IE-21"], rationale: "Helium-to-water steam generator. In the HTGR the leak is water into helium (secondary pressure exceeds primary helium), a moisture-ingress initiator." },
    { id: "GI-09", name: "Loss of a vital AC bus", source: "NUREG/CR-5750", applicable: true, derivedInitiatorIds: ["IE-27"], rationale: "AC distribution powers the circulators, instrumentation and balance of plant." },
    { id: "GI-10", name: "Loss of a vital DC bus", source: "NUREG/CR-5750", applicable: true, derivedInitiatorIds: ["IE-29"], rationale: "DC power feeds protection logic and control; loss degrades actuation." },
    { id: "GI-11", name: "Loss of instrument / control air", source: "NUREG/CR-5750", applicable: true, derivedInitiatorIds: ["IE-33"], rationale: "Instrument air drives pneumatic valves and dampers across the helium and steam-cycle systems." },
    { id: "GI-12", name: "Loss of component cooling water", source: "EPRI initiating-event catalogue", applicable: true, derivedInitiatorIds: ["IE-31"], rationale: "Closed cooling loop serving circulator bearings and seals, pumps and coolers." },
    { id: "GI-13", name: "Loss of service water / ultimate heat sink", source: "EPRI initiating-event catalogue", applicable: true, derivedInitiatorIds: ["IE-32"], rationale: "Service water rejects heat from the auxiliary and forced-cooling chains." },
    { id: "GI-14", name: "Partial loss of service water", source: "EPRI initiating-event catalogue", applicable: true, derivedInitiatorIds: ["IE-32"], rationale: "Multi-train service water; partial loss grouped under the service-water initiator." },
    { id: "GI-15", name: "Excessive feedwater / overcooling transient", source: "NUREG/CR-5750", applicable: true, derivedInitiatorIds: ["IE-11"], rationale: "Excessive feedwater overcools the primary and inserts positive reactivity through the temperature feedback." },
    { id: "GI-16", name: "Reactor coolant pump trip / loss of forced primary flow", source: "NUREG/CR-5750", applicable: true, derivedInitiatorIds: ["IE-01"], rationale: "The HTGR uses helium circulators rather than LWR coolant pumps, but the loss-of-forced-flow initiator is the direct analogue." },
    { id: "GI-17", name: "Loss-of-coolant accident (LWR pipe-break size bins)", source: "NUREG/CR-5750", applicable: false, derivedInitiatorIds: [], rationale: "The LWR LOCA size bins (large, medium, small break with ECCS reflood) do not transfer: the primary coolant is single-phase helium with no flashing or reflood. Helium depressurization is covered by the HTGR-specific boundary-break initiators IE-15, IE-16 and IE-17." },
  ],
};
