...
import { HIGH_WINDS_PRA_ANALYSIS } from "./high-winds-pra-seed";
import { HIGH_WINDS_PRA_ANALYSIS_SFR } from "./high-winds-pra-seed-sfr";
import { EXTERNAL_FLOOD_PRA_ANALYSIS } from "./external-flood-pra-seed";
...
const HR_HCL_CASE_SLUG = "hr-hcl-case-study";
const DA_GENERIC_1_SLUG = "da-generic-1";
const DA_GENERIC_2_SLUG = "da-generic-2";
const DA_HCL_CASE_SLUG = "da-hcl-case-study";
...
const RC_HCL_CASE_SLUG = "rc-hcl-case-study";
const RI_GENERIC_1_SLUG = "ri-generic-1";
const RI_GENERIC_2_SLUG = "ri-generic-2";
const RI_HCL_CASE_SLUG = "ri-hcl-case-study";
...
const HIGH_WINDS_PRA_GENERIC_1_SLUG = "high-winds-pra-generic-1";
const HIGH_WINDS_PRA_GENERIC_2_SLUG = "high-winds-pra-generic-2";
const EXTERNAL_FLOOD_PRA_GENERIC_1_SLUG = "external-flood-pra-generic-1";
const EXTERNAL_FLOOD_PRA_GENERIC_2_SLUG = "external-flood-pra-generic-2";
const OTHER_HAZARDS_PRA_GENERIC_1_SLUG = "other-hazards-pra-generic-1";
const OTHER_HAZARDS_PRA_GENERIC_2_SLUG = "other-hazards-pra-generic-2";
...
const HR_EXAMPLES: PosExampleEntry[] = [
  ...
  { id: HCL_CASE_ID, label: HCL_CASE_LABEL, slug: HR_HCL_CASE_SLUG },
];
...
const DA_EXAMPLES: PosExampleEntry[] = [
  ...
  { id: HCL_CASE_ID, label: HCL_CASE_LABEL, slug: DA_HCL_CASE_SLUG },
];
...
const HIGH_WINDS_PRA_EXAMPLES: PosExampleEntry[] = [
  { id: "htgr", label: "Generic HTGR", slug: HIGH_WINDS_PRA_GENERIC_1_SLUG },
  { id: "sfr", label: "Generic SFR", slug: HIGH_WINDS_PRA_GENERIC_2_SLUG },
];

const EXTERNAL_FLOOD_PRA_EXAMPLES: PosExampleEntry[] = [
  { id: "htgr", label: "Generic HTGR", slug: EXTERNAL_FLOOD_PRA_GENERIC_1_SLUG },
  { id: "sfr", label: "Generic SFR", slug: EXTERNAL_FLOOD_PRA_GENERIC_2_SLUG },
];

const OTHER_HAZARDS_PRA_EXAMPLES: PosExampleEntry[] = [
  { id: "htgr", label: "Generic HTGR", slug: OTHER_HAZARDS_PRA_GENERIC_1_SLUG },
  { id: "sfr", label: "Generic SFR", slug: OTHER_HAZARDS_PRA_GENERIC_2_SLUG },
];
...
const SEEDS: SeedEntry[] = [
  ...
  { slug: HR_HCL_CASE_SLUG, kind: "HRA", mef: HR_ANALYSIS_HCL },
  { slug: DA_GENERIC_1_SLUG, kind: "DA", mef: DA_ANALYSIS },
  { slug: DA_GENERIC_2_SLUG, kind: "DA", mef: DA_ANALYSIS_HTGR },
  { slug: DA_HCL_CASE_SLUG, kind: "DA", mef: DA_ANALYSIS_HCL },
  ...
  { slug: HIGH_WINDS_PRA_GENERIC_1_SLUG, kind: "W", mef: HIGH_WINDS_PRA_ANALYSIS },
  { slug: HIGH_WINDS_PRA_GENERIC_2_SLUG, kind: "W", mef: HIGH_WINDS_PRA_ANALYSIS_SFR },
  { slug: EXTERNAL_FLOOD_PRA_GENERIC_1_SLUG, kind: "XF", mef: EXTERNAL_FLOOD_PRA_ANALYSIS },
  { slug: EXTERNAL_FLOOD_PRA_GENERIC_2_SLUG, kind: "XF", mef: EXTERNAL_FLOOD_PRA_ANALYSIS_SFR },
  { slug: OTHER_HAZARDS_PRA_GENERIC_1_SLUG, kind: "O", mef: OTHER_HAZARDS_PRA_ANALYSIS },
  { slug: OTHER_HAZARDS_PRA_GENERIC_2_SLUG, kind: "O", mef: OTHER_HAZARDS_PRA_ANALYSIS_SFR },
