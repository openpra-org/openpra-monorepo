...
const compiledRiskInputs: CompiledRiskInput[] = [
  {
    ...
    frequencyDistribution: { type: DistributionType.LOGNORMAL, median: 4.7e-8, errorFactor: 3.2 },
  ...
  },
  {
    ...
    frequency: 4.5e-8,
    frequencyUnit: "per plant-year",
    frequencyDistribution: { type: DistributionType.LOGNORMAL, median: 4.1e-8, errorFactor: 3.3 },
  ...
  },
  {
    ...
    frequency: 6.7e-7,
    frequencyUnit: "per plant-year",
    frequencyDistribution: { type: DistributionType.LOGNORMAL, median: 6.0e-7, errorFactor: 3.4 },
    esqFamilyQuantificationRef: "EFQ-1",
    consequences: [
  ...
  },
  {
    ...
    frequency: 3.3e-5,
    frequencyUnit: "per plant-year",
    frequencyDistribution: { type: DistributionType.LOGNORMAL, median: 3.0e-5, errorFactor: 2.8 },
...
const integratedRiskResults: IntegratedRiskResults = {
  ...
  metrics: [
    {
      ...
      uncertainty: { type: DistributionType.LOGNORMAL, median: 2.7e-11, errorFactor: 2.75 },
      acceptanceCriteria: {
        limit: 2.0e-9,
  ...
  frequencyConsequencePlotData: [
    { eventSequenceRef: "ESF-EARLY", eventSequenceName: "Confinement failure, early release", frequency: 5.2e-8, consequence: 8.0e-2, consequenceMetric: "Site-boundary individual dose" },
    { eventSequenceRef: "ESF-ATWS", eventSequenceName: "Unprotected (ATWS) transients", frequency: 4.5e-8, consequence: 8.0e-2, consequenceMetric: "Site-boundary individual dose" },
    { eventSequenceRef: "ESF-LATE", eventSequenceName: "DHR failure, late filtered release", frequency: 6.7e-7, consequence: 4.0e-3, consequenceMetric: "Site-boundary individual dose" },
    { eventSequenceRef: "ESF-LEAK", eventSequenceName: "Intact-confinement leakage", frequency: 3.3e-5, consequence: 1.0e-6, consequenceMetric: "Site-boundary individual dose" },
  ],
  exceedanceFrequencyCurveData: [
    {
      consequenceMetric: "Site-boundary individual dose",
      dataPoints: [
        { consequenceValue: 1e-6, exceedanceFrequency: 3.4e-5 },
        { consequenceValue: 1e-4, exceedanceFrequency: 7.7e-7 },
        { consequenceValue: 4e-3, exceedanceFrequency: 7.7e-7 },
        { consequenceValue: 2e-2, exceedanceFrequency: 9.7e-8 },
        { consequenceValue: 8e-2, exceedanceFrequency: 9.7e-8 },
  ...
  aggregationApproach: {
    ...
    detailConservatismDifferences: [
      ...
      { scope: "Seismic", description: "The seismic-initiated members of the early-release pair run a conservative CC-I model." },
    ],
...
const significantContributors: SignificantRiskContributors = {
  ...
  significantEventSequenceFamilies: [
    ...
    },
    {
      ...
      sourceId: "ESF-ATWS",
      importanceLevel: ImportanceLevel.HIGH,
      context: "The unprotected transients, the second driver, conservative pending the dedicated tree.",
    },
    {
      uuid: "SC-ESF-LATE",
...
const uncertaintyAnalyses: RiskUncertaintyAnalysis[] = [
  {
    ...
    parameterUncertainty: { type: DistributionType.LOGNORMAL, median: 2.7e-11, errorFactor: 2.75 },
...
const documentation: RiDocumentation = {
  ...
  resultsSummary: "The integrated latent cancer risk is 2.7E-11 per plant-year, below the 2.0E-9 target, driven by the early-release pair.",
  ...
  acceptanceCriteriaComparison: "Both cumulative metrics are compliant, the latent risk at about one percent of its target and the dose risk at ten percent.",
...
export const RI_ANALYSIS: RiskIntegration = {
  ...
  scopeDefinition: {
    ...
    releaseCategoryRefs: ["RC-3", "RC-2", "RC-1"],
