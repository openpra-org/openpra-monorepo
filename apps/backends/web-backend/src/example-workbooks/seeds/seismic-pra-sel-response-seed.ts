...
function equipmentTemplates(
  ...
  return [
    ...
    {
      id: "RCCS-AIR-INLET",
      name: "RCCS air inlet and chimney",
      sscType: "STRUCTURE",
      building: "RCCS intake and chimney structure",
      room: "Exterior intake through exhaust stack",
      elevation: "1444-1502 m",
      function: "Preserve the ultimate passive heat sink and natural-draft flow path",
      failureName: "RCCS intake blockage or chimney structural failure",
      failureType: "STRUCTURAL",
      requiredState: "FUNCTION_AFTER_EARTHQUAKE",
      consequence: "Reduces passive heat rejection for all connected modules.",
      inclusionSources: ["ADDITIONAL_SEISMIC_SSC", "SEISMIC_EVENT_SEQUENCE_MODEL"],
      disposition: "ABOVE_FRAGILITY_THRESHOLD",
      dispositionBasis: "Stack shell, supports, intake louvers, and debris exclusion exceed threshold.",
      mounting: "Reinforced-concrete intake with braced steel exhaust stack.",
...
function structuralModels(
  ...
  const configurations: {
    ...
    : [
      ...
      { id: "DHR", name: "RCCS intake and chimney model", structureRef: "STRUCTURE-RCCS-INTAKE", condition: "AS_DESIGNED", foundation: "Shallow foundation with translational and rocking springs.", frequency: 2.7, limitation: "Final intake louver stiffness is bounded by sensitivity cases." },
