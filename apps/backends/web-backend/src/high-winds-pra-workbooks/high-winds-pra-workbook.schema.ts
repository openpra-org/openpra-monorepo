...
export type HighWindsPraWorkbookDocument = HydratedDocument<HighWindsPraWorkbook> & { createdAt: Date; updatedAt: Date };

@Schema({ timestamps: true, collection: "high_winds_pra_workbooks", minimize: false })
export class HighWindsPraWorkbook {
...
export const HighWindsPraWorkbookSchema = SchemaFactory.createForClass(HighWindsPraWorkbook);
