    ...
    <div>
      ...
      {items.map((x, i) => (
        <div key={i} className="posrow" style={{ gap: 6, marginBottom: 6 }}>
          <input className="posfield__input" value={x} disabled={disabled} onChange={(e) => onApply(items.map((y, j) => (j === i ? e.target.value : y)))} />
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield"><label className="posfield__label">Name</label><input className="posfield__input" value={p.name} disabled={!editable} onChange={(e) => patchParam({ name: e.target.value })} /></div>
          <div className="posfield"><label className="posfield__label">Description</label><textarea className="posfield__textarea" rows={3} style={{ resize: "vertical" }} value={p.description ?? ""} disabled={!editable} onChange={(e) => patchParam({ description: e.target.value === "" ? undefined : e.target.value })} /></div>
          <div className="posfield-grid">
            ...
            <div className="posfield"><label className="posfield__label">Value</label><input className="posfield__input" type="number" step="any" value={p.value} disabled={!editable} onChange={(e) => { const v = Number(e.target.value); if (!Number.isNaN(v)) patchParam({ value: v }); }} /></div>
            ...
            <div className="posfield"><label className="posfield__label">Operating state</label>{(links?.posStates ?? []).length > 0 ? <select className="posfield__select" value={p.plantOperatingStateRef ?? ""} disabled={!editable} onChange={(e) => patchParam({ plantOperatingStateRef: e.target.value === "" ? undefined : e.target.value })}><option value="">—</option>{(links?.posStates ?? []).map((st) => <option key={st.id} value={st.id}>{st.id} · {st.name}</option>)}</select> : <input className="posfield__input posmono" value={p.plantOperatingStateRef ?? ""} disabled={!editable} onChange={(e) => patchParam({ plantOperatingStateRef: e.target.value === "" ? undefined : e.target.value })} />}</div>
            <div className="posfield"><label className="posfield__label">Basic event</label><input className="posfield__input posmono" value={p.basicEventRef ?? ""} disabled={!editable} onChange={(e) => patchParam({ basicEventRef: e.target.value === "" ? undefined : e.target.value })} /></div>
            <div className="posfield"><label className="posfield__label">System</label><input className="posfield__input posmono" value={p.systemReference ?? ""} disabled={!editable} onChange={(e) => patchParam({ systemReference: e.target.value === "" ? undefined : e.target.value })} /></div>
          ...
          <div className="posfield"><label className="posfield__label">Model selection basis</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={p.modelSelectionBasis ?? ""} disabled={!editable} onChange={(e) => patchParam({ modelSelectionBasis: e.target.value === "" ? undefined : e.target.value })} /></div>
          <div className="posfield"><label className="posfield__label">Required data</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={p.requiredData ?? ""} disabled={!editable} onChange={(e) => patchParam({ requiredData: e.target.value === "" ? undefined : e.target.value })} /></div>
          <div className="posfield"><label className="posfield__label">Multi-state applicability</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={p.multiPosApplicabilityJustification ?? ""} disabled={!editable} onChange={(e) => patchParam({ multiPosApplicabilityJustification: e.target.value === "" ? undefined : e.target.value })} /></div>
        </div>
      </>
    );
  }
  ...
  if (context.kind === "boundary") {
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield-grid">
            <div className="posfield"><label className="posfield__label">Name</label><input className="posfield__input" value={b.name} disabled={!editable} onChange={(e) => patchBoundary({ name: e.target.value })} /></div>
            <div className="posfield"><label className="posfield__label">System</label><input className="posfield__input posmono" value={b.systemId} disabled={!editable} onChange={(e) => patchBoundary({ systemId: e.target.value })} /></div>
          </div>
          <div className="posfield"><label className="posfield__label">Description</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={b.description} disabled={!editable} onChange={(e) => patchBoundary({ description: e.target.value })} /></div>
          <div className="posfield"><label className="posfield__label">Boundary scope</label><input className="posfield__input" value={b.boundaries[0] ?? ""} disabled={!editable} onChange={(e) => patchBoundary({ boundaries: [e.target.value, ...b.boundaries.slice(1)] })} /></div>
          <div className="posfield"><label className="posfield__label">Boundary basis</label><textarea className="posfield__textarea" rows={3} style={{ resize: "vertical" }} value={b.boundaryBasis} disabled={!editable} onChange={(e) => patchBoundary({ boundaryBasis: e.target.value })} /></div>
          <div>
            <div className="essec">Included items</div>
            {b.includedItems.map((x, i) => (
              <div key={i} className="posrow" style={{ gap: 6, marginBottom: 6 }}>
                <input className="posfield__input" value={x} disabled={!editable} onChange={(e) => patchBoundary({ includedItems: b.includedItems.map((y, j) => (j === i ? e.target.value : y)) })} />
          ...
          <div>
            ...
            {(b.excludedItems ?? []).map((x, i) => (
              <div key={i} className="posrow" style={{ gap: 6, marginBottom: 6 }}>
                <input className="posfield__input" value={x} disabled={!editable} onChange={(e) => patchBoundary({ excludedItems: (b.excludedItems ?? []).map((y, j) => (j === i ? e.target.value : y)) })} />
  ...
  if (context.kind === "grouping") {
    ...
    const listEditor = (label: string, items: string[], apply: (next: string[]) => void): JSX.Element => (
      <div>
        ...
        {items.map((x, i) => (
          <div key={i} className="posrow" style={{ gap: 6, marginBottom: 6 }}>
            <input className="posfield__input" value={x} disabled={!editable} onChange={(e) => apply(items.map((y, j) => (j === i ? e.target.value : y)))} />
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield-grid">
            <div className="posfield"><label className="posfield__label">Name</label><input className="posfield__input" value={g.name} disabled={!editable} onChange={(e) => patchGrouping({ name: e.target.value })} /></div>
            <div className="posfield"><label className="posfield__label">System</label><input className="posfield__input posmono" value={g.systemId} disabled={!editable} onChange={(e) => patchGrouping({ systemId: e.target.value })} /></div>
          ...
          <div className="posfield"><label className="posfield__label">Grouping justification</label><textarea className="posfield__textarea" rows={3} style={{ resize: "vertical" }} value={g.groupingJustification} disabled={!editable} onChange={(e) => patchGrouping({ groupingJustification: e.target.value })} /></div>
  ...
  if (context.kind === "outlier") {
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield-grid">
            <div className="posfield"><label className="posfield__label">Component</label><input className="posfield__input" value={o.componentId} disabled={!editable} onChange={(e) => patchOutlier({ componentId: e.target.value })} /></div>
            <div className="posfield"><label className="posfield__label">System</label><input className="posfield__input posmono" value={o.systemId} disabled={!editable} onChange={(e) => patchOutlier({ systemId: e.target.value })} /></div>
          ...
          <div className="posfield"><label className="posfield__label">Exclusion reason</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={o.exclusionReason} disabled={!editable} onChange={(e) => patchOutlier({ exclusionReason: e.target.value })} /></div>
          <div className="posfield"><label className="posfield__label">Exclusion justification</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={o.exclusionJustification} disabled={!editable} onChange={(e) => patchOutlier({ exclusionJustification: e.target.value })} /></div>
          <div className="posfield"><label className="posfield__label">Alternative handling</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={o.alternativeHandling} disabled={!editable} onChange={(e) => patchOutlier({ alternativeHandling: e.target.value })} /></div>
          <div>
            <div className="essec">Differentiating characteristics</div>
            {o.differentiatingCharacteristics.map((x, i) => (
              <div key={i} className="posrow" style={{ gap: 6, marginBottom: 6 }}>
                <input className="posfield__input" value={x} disabled={!editable} onChange={(e) => patchOutlier({ differentiatingCharacteristics: o.differentiatingCharacteristics.map((y, j) => (j === i ? e.target.value : y)) })} />
  ...
  if (context.kind === "source") {
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield"><label className="posfield__label">Name</label><input className="posfield__input" value={src.name} disabled={!editable} onChange={(e) => patch({ name: e.target.value })} /></div>
          <div className="posfield-grid">
            ...
            <div className="posfield"><label className="posfield__label">Location</label><input className="posfield__input" value={src.sourceLocation} disabled={!editable} onChange={(e) => patch({ sourceLocation: e.target.value })} /></div>
            <div className="posfield"><label className="posfield__label">Period start</label><input className="posfield__input posmono" value={src.timePeriod.start} disabled={!editable} onChange={(e) => patch({ timePeriod: { ...src.timePeriod, start: e.target.value } })} /></div>
            <div className="posfield"><label className="posfield__label">Period end</label><input className="posfield__input posmono" value={src.timePeriod.end} disabled={!editable} onChange={(e) => patch({ timePeriod: { ...src.timePeriod, end: e.target.value } })} /></div>
            <div className="posfield"><label className="posfield__label">Access method</label><input className="posfield__input" value={src.accessMethod} disabled={!editable} onChange={(e) => patch({ accessMethod: e.target.value })} /></div>
            <div className="posfield"><label className="posfield__label">Data format</label><input className="posfield__input" value={src.dataFormat} disabled={!editable} onChange={(e) => patch({ dataFormat: e.target.value })} /></div>
          </div>
          <div className="posfield"><label className="posfield__label">Quality assurance</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={src.qualityAssurance ?? ""} disabled={!editable} onChange={(e) => patch({ qualityAssurance: e.target.value === "" ? undefined : e.target.value })} /></div>
          <div className="posfield"><label className="posfield__label">Validation method</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={src.validationMethod ?? ""} disabled={!editable} onChange={(e) => patch({ validationMethod: e.target.value === "" ? undefined : e.target.value })} /></div>
  ...
  if (context.kind === "failuredef") {
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield"><label className="posfield__label">Definition basis</label><textarea className="posfield__textarea" rows={3} style={{ resize: "vertical" }} value={fd.failureDefinitionBasis} disabled={!editable} onChange={(e) => patch({ failureDefinitionBasis: e.target.value })} /></div>
      ...
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield-grid">
            ...
            <div className="posfield"><label className="posfield__label">Surveillance demands</label><input className="posfield__input posmono" type="number" value={d.surveillanceTestDemands ?? 0} disabled={!editable} onChange={(e) => { const n = num(e.target.value); if (n !== undefined) patch({ surveillanceTestDemands: n }); }} /></div>
            <div className="posfield"><label className="posfield__label">Maintenance demands</label><input className="posfield__input posmono" type="number" value={d.maintenanceActDemands ?? 0} disabled={!editable} onChange={(e) => { const n = num(e.target.value); if (n !== undefined) patch({ maintenanceActDemands: n }); }} /></div>
            <div className="posfield"><label className="posfield__label">Operational demands</label><input className="posfield__input posmono" type="number" value={d.operationalDemands ?? 0} disabled={!editable} onChange={(e) => { const n = num(e.target.value); if (n !== undefined) patch({ operationalDemands: n }); }} /></div>
            <div className="posfield"><label className="posfield__label">Total demands</label><input className="posfield__input posmono" type="number" value={d.totalDemands} disabled={!editable} onChange={(e) => { const n = num(e.target.value); if (n !== undefined) patch({ totalDemands: n }); }} /></div>
          </div>
        </div>
      </>
    );
      ...
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield-grid">
            ...
            <div className="posfield"><label className="posfield__label">Standby hours</label><input className="posfield__input posmono" type="number" value={ex.standbyHours ?? 0} disabled={!editable} onChange={(e) => { const n = num(e.target.value); if (n !== undefined) patch({ standbyHours: n }); }} /></div>
            <div className="posfield"><label className="posfield__label">Operating hours</label><input className="posfield__input posmono" type="number" value={ex.operatingHours ?? 0} disabled={!editable} onChange={(e) => { const n = num(e.target.value); if (n !== undefined) patch({ operatingHours: n }); }} /></div>
          </div>
        </div>
      </>
    );
  ...
  if (context.kind === "testcred") {
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield"><label className="posfield__label">Test procedure</label><input className="posfield__input" value={t.testProcedureReference} disabled={!editable} onChange={(e) => patch({ testProcedureReference: e.target.value })} /></div>
          ...
          <div className="posfield"><label className="posfield__label">Demand crediting decision</label><textarea className="posfield__textarea" rows={3} style={{ resize: "vertical" }} value={t.demandCreditingDecision} disabled={!editable} onChange={(e) => patch({ demandCreditingDecision: e.target.value })} /></div>
        </div>
      </>
    );
  }
  ...
  if (context.kind === "unavail") {
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield-grid">
            <div className="posfield"><label className="posfield__label">Component or train</label><input className="posfield__input" value={u.componentOrTrainReference} disabled={!editable} onChange={(e) => patch({ componentOrTrainReference: e.target.value })} /></div>
            <div className="posfield"><label className="posfield__label">System</label><input className="posfield__input posmono" value={u.systemReference ?? ""} disabled={!editable} onChange={(e) => patch({ systemReference: e.target.value === "" ? undefined : e.target.value })} /></div>
            <div className="posfield"><label className="posfield__label">Assigned to support system</label><input className="posfield__input posmono" value={u.assignedToSupportSystem ?? ""} disabled={!editable} onChange={(e) => patch({ assignedToSupportSystem: e.target.value === "" ? undefined : e.target.value })} /></div>
          </div>
          <div>
            <div className="essec">Contributing activities</div>
            {u.contributingActivities.map((a, i) => (
              <div key={i} className="posrow" style={{ gap: 6, marginBottom: 6, flexWrap: "wrap" }}>
                <input className="posfield__input" style={{ flex: 2, minWidth: 140 }} value={a.activity} disabled={!editable} onChange={(e) => patch({ contributingActivities: u.contributingActivities.map((y, j) => (j === i ? { ...y, activity: e.target.value } : y)) })} />
                <input className="posfield__input posmono" style={{ width: 90 }} type="number" step="any" value={a.durationHours} disabled={!editable} onChange={(e) => { const n = Number(e.target.value); if (!Number.isNaN(n)) patch({ contributingActivities: u.contributingActivities.map((y, j) => (j === i ? { ...y, durationHours: n } : y)) }); }} />
          ...
          <div className="posfield"><label className="posfield__label">Pre-operational basis</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={u.preOperationalAssumptionsBasis ?? ""} disabled={!editable} onChange={(e) => patch({ preOperationalAssumptionsBasis: e.target.value === "" ? undefined : e.target.value })} /></div>
        </div>
      </>
    );
  }
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          ...
          <div className="posfield"><label className="posfield__label">Planned activity</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={c.plannedActivityDescription} disabled={!editable} onChange={(e) => patch({ plannedActivityDescription: e.target.value })} /></div>
          <div className="posfield-grid">
            <div className="posfield"><label className="posfield__label">Unavailability</label><input className="posfield__input posmono" type="number" step="any" value={c.unavailabilityValue ?? 0} disabled={!editable} onChange={(e) => { const n = Number(e.target.value); if (!Number.isNaN(n)) patch({ unavailabilityValue: n }); }} /></div>
            ...
            <div className="posfield"><label className="posfield__label">Systems Analysis event</label><input className="posfield__input posmono" value={c.systemsAnalysisSimultaneousEventRef ?? ""} disabled={!editable} onChange={(e) => patch({ systemsAnalysisSimultaneousEventRef: e.target.value === "" ? undefined : e.target.value })} /></div>
          </div>
        </div>
      </>
    );
  ...
  if (context.kind === "repair") {
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield-grid">
            <div className="posfield"><label className="posfield__label">SSC</label><input className="posfield__input" value={r.sscReference} disabled={!editable} onChange={(e) => patch({ sscReference: e.target.value })} /></div>
            <div className="posfield"><label className="posfield__label">Identification to restoration (h)</label><input className="posfield__input posmono" type="number" step="any" value={r.repairEvents[0]?.identificationToRestorationHours ?? 0} disabled={!editable} onChange={(e) => { const n = Number(e.target.value); if (!Number.isNaN(n)) patch({ repairEvents: [{ ...r.repairEvents[0], identificationToRestorationHours: n }] }); }} /></div>
          </div>
          <div className="posfield"><label className="posfield__label">Pre-operational basis</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={r.preOperationalAssumptionsBasis ?? ""} disabled={!editable} onChange={(e) => patch({ preOperationalAssumptionsBasis: e.target.value === "" ? undefined : e.target.value })} /></div>
          <div className="posfield"><label className="posfield__label">Operating-state influences</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={r.plantOperatingStateInfluences ?? ""} disabled={!editable} onChange={(e) => patch({ plantOperatingStateInfluences: e.target.value === "" ? undefined : e.target.value })} /></div>
        </div>
      </>
    );
  }
  ...
  if (context.kind === "recovery") {
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield-grid">
            <div className="posfield"><label className="posfield__label">Function lost</label><input className="posfield__input" value={r.functionLost} disabled={!editable} onChange={(e) => patch({ functionLost: e.target.value })} /></div>
            <div className="posfield"><label className="posfield__label">Identification to restoration (h)</label><input className="posfield__input posmono" type="number" step="any" value={r.recoveryEvents[0]?.identificationToRestorationHours ?? 0} disabled={!editable} onChange={(e) => { const n = Number(e.target.value); if (!Number.isNaN(n)) patch({ recoveryEvents: [{ ...r.recoveryEvents[0], identificationToRestorationHours: n }] }); }} /></div>
          </div>
  ...
  if (context.kind === "outage") {
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield-grid">
            <div className="posfield"><label className="posfield__label">Outage type</label><input className="posfield__input" value={o.outageType} disabled={!editable} onChange={(e) => patch({ outageType: e.target.value })} /></div>
            <div className="posfield"><label className="posfield__label">Operating state</label>{(links?.posStates ?? []).length > 0 ? <select className="posfield__select" value={o.plantOperatingStateRef ?? ""} disabled={!editable} onChange={(e) => patch({ plantOperatingStateRef: e.target.value === "" ? undefined : e.target.value })}><option value="">—</option>{(links?.posStates ?? []).map((st) => <option key={st.id} value={st.id}>{st.id} · {st.name}</option>)}</select> : <input className="posfield__input posmono" value={o.plantOperatingStateRef ?? ""} disabled={!editable} onChange={(e) => patch({ plantOperatingStateRef: e.target.value === "" ? undefined : e.target.value })} />}</div>
            <div className="posfield"><label className="posfield__label">Duration (h)</label><input className="posfield__input posmono" type="number" step="any" value={o.durationHours ?? 0} disabled={!editable} onChange={(e) => { const n = Number(e.target.value); if (!Number.isNaN(n)) patch({ durationHours: n }); }} /></div>
            <div className="posfield"><label className="posfield__label">Outages per year</label><input className="posfield__input posmono" type="number" step="any" value={o.outagesPerCalendarYear ?? 0} disabled={!editable} onChange={(e) => { const n = Number(e.target.value); if (!Number.isNaN(n)) patch({ outagesPerCalendarYear: n }); }} /></div>
          </div>
          <div className="posfield"><label className="posfield__label">POS data link basis</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={o.posDataLinkBasis ?? ""} disabled={!editable} onChange={(e) => patch({ posDataLinkBasis: e.target.value === "" ? undefined : e.target.value })} /></div>
        </div>
      </>
    );
  }
  ...
  if (context.kind === "ccf") {
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield-grid">
            <div className="posfield"><label className="posfield__label">CCF group</label><input className="posfield__input posmono" value={c.ccfGroupReference} disabled={!editable} onChange={(e) => patch({ ccfGroupReference: e.target.value })} /></div>
          ...
          <div>
            ...
            {Object.entries(c.parameters).map(([k, v]) => (
              <div key={k} className="posrow" style={{ gap: 6, marginBottom: 6, alignItems: "center" }}>
                ...
                <input className="posfield__input posmono" type="number" step="any" value={v} disabled={!editable} onChange={(e) => { const n = Number(e.target.value); if (!Number.isNaN(n)) patch({ parameters: { ...c.parameters, [k]: n } }); }} />
          ...
          <div className="posfield"><label className="posfield__label">Boundary consistency basis</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={c.componentBoundaryConsistencyBasis} disabled={!editable} onChange={(e) => patch({ componentBoundaryConsistencyBasis: e.target.value })} /></div>
          <div className="posfield-grid">
  ...
  if (context.kind === "uncsource") {
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield"><label className="posfield__label">Source</label><input className="posfield__input" value={u.source} disabled={!editable} onChange={(e) => patch({ source: e.target.value })} /></div>
          <div className="posfield"><label className="posfield__label">Impact</label><textarea className="posfield__textarea" rows={3} style={{ resize: "vertical" }} value={u.impact} disabled={!editable} onChange={(e) => patch({ impact: e.target.value })} /></div>
        </div>
      </>
    );
  }
  ...
  if (context.kind === "preop") {
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield"><label className="posfield__label">Area</label><input className="posfield__input" value={a.influenceOnDefinition} disabled={!editable} onChange={(e) => patch({ influenceOnDefinition: e.target.value })} /></div>
          <div className="posfield"><label className="posfield__label">Description</label><textarea className="posfield__textarea" rows={3} style={{ resize: "vertical" }} value={a.description} disabled={!editable} onChange={(e) => patch({ description: e.target.value })} /></div>
          <div className="posfield"><label className="posfield__label">Closure basis</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={a.closureBasis ?? ""} disabled={!editable} onChange={(e) => patch({ closureBasis: e.target.value })} /></div>
        </div>
      </>
    );
  }
  ...
  if (context.kind === "sens") {
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield"><label className="posfield__label">Name</label><input className="posfield__input" value={st.name ?? ""} disabled={!editable} onChange={(e) => patch({ name: e.target.value })} /></div>
          <div className="posfield"><label className="posfield__label">Description</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={st.description ?? ""} disabled={!editable} onChange={(e) => patch({ description: e.target.value })} /></div>
          <div className="posfield"><label className="posfield__label">Results</label><textarea className="posfield__textarea" rows={3} style={{ resize: "vertical" }} value={st.results ?? ""} disabled={!editable} onChange={(e) => patch({ results: e.target.value })} /></div>
        </div>
      </>
    );
  }
  ...
  if (context.kind === "datamod") {
    ...
    return (
      <>
        ...
        <div className="posdrawer__body">
          <div className="posfield"><label className="posfield__label">Modification</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={d.modificationDescription} disabled={!editable} onChange={(e) => patch({ modificationDescription: e.target.value })} /></div>
          ...
          <div className="posfield"><label className="posfield__label">Basis</label><textarea className="posfield__textarea" rows={2} style={{ resize: "vertical" }} value={d.basis} disabled={!editable} onChange={(e) => patch({ basis: e.target.value })} /></div>
