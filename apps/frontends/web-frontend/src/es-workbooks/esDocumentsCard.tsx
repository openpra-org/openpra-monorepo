...
function EsDocumentsCard({ workbookId, canEdit }: { workbookId?: string; canEdit: boolean }): JSX.Element {
  ...
  return (
    <div className="poscard">
      ...
      <p className="poscard__sub">Design-basis documents, plant-response calculations, and method references that support this event-sequence analysis.</p>
