...
const IE_SR_DESCRIPTIONS: Record<string, string> = {
  "IE-A1":  "IE-A1 — Initiating events challenging operation or safe shutdown identified by a structured, systematic, plant-specific process",
  "IE-A2":  "IE-A2 — Mechanisms that could mobilise each in-scope radioactive source identified and included",
  "IE-A3":  "IE-A3 — Operating plants: IE delineation consistent with the as-built / as-operated plant",
  "IE-A4":  "IE-A4 — Pre-operational: IE delineation consistent with available design information",
  "IE-A5":  "IE-A5 — All seven challenge categories considered (transient, RCB breach, interfacing-system breach, special, internal & external hazard, at-initiator HFE)",
  "IE-A6":  "IE-A6 — Hazard-combination initiators included (e.g. seismically-induced fire)",
  "IE-A7":  "IE-A7 — Operating plants: plant-specific IE experience reviewed across all operating states",
  "IE-A8":  "IE-A8 — Generic analyses and operating experience of similar plants reviewed for completeness",
  "IE-A9":  "IE-A9 — Each system and support system evaluated to subsystem / train level for IE potential (CC-II: structured FMEA / HAZOPS)",
  "IE-A10": "IE-A10 — Multiple-failure initiators (common-cause, maintenance alignments) included in the systematic evaluation",
  "IE-A11": "IE-A11 — Events that occurred at this and similar plants / systems across applicable states included",
  "IE-A12": "IE-A12 — Identified events evaluated for overlooked initiators (CC-II: investigation, not just an interview)",
  "IE-A13": "IE-A13 — Operating plants: operating experience reviewed for IE precursors and human-failure initiators",
  "IE-A14": "IE-A14 — Pre-operational: similar-plant operating experience reviewed for IE precursors, where similar plants exist",
  "IE-A15": "IE-A15 — System and support-system alignments, including temporary maintenance alignments, included in the IE search",
  "IE-A16": "IE-A16 — Multi-reactor / multi-source initiators identified, with the reactors and sources each impacts",
  "IE-A17": "IE-A17 — Model-uncertainty sources, assumptions & alternatives in IE identification identified (→ HLR-ESQ-E)",
  "IE-A18": "IE-A18 — Pre-operational: assumptions from missing as-built / as-operated detail in IE identification logged",
  "IE-B1":  "IE-B1 — Grouping facilitates ES & ESQ and is justified not to change risk-significant sequences",
  "IE-B2":  "IE-B2 — A structured, systematic process used for grouping initiating events",
  "IE-B3":  "IE-B3 — Pre-operational: grouping detail consistent with available design information",
  "IE-B4":  "IE-B4 — Events grouped only when similar or bounded by worst-case, without impacting risk-significant sequences (CC-II)",
  "IE-B5":  "IE-B5 — Multi-reactor plants: IE groups impacting specific reactor / source combinations identified",
  "IE-B6":  "IE-B6 — Pre-operational: assumptions from missing as-built detail affecting IE grouping identified",
  "IE-C1":  "IE-C1 — Operating plants: IE frequency from generic + plant/design data representative of current performance",
  "IE-C2":  "IE-C2 — Pre-operational: IE frequency from generic, design-specific and similar-plant data",
  "IE-C3":  "IE-C3 — Operating plants: data representative of current design and performance used",
  "IE-C4":  "IE-C4 — Recovery actions included as appropriate and each justified (procedures / training)",
  "IE-C5":  "IE-C5 — Pre-operational: recovery actions included and justified consistent with the operating philosophy",
  "IE-C6":  "IE-C6 — Operating plants: generic + plant-specific data combined by a Bayesian (or equivalent) update",
  "IE-C7":  "IE-C7 — Pre-operational: relevant experience from other facilities used where NPP data are insufficient",
  "IE-C8":  "IE-C8 — Frequencies on a plant-calendar-year basis with the POS time fraction applied",
  "IE-C9":  "IE-C9 — Screening uses the barrier-integrity precondition plus the SCR criteria",
  "IE-C10": "IE-C10 — Data ensured representative of plant design and operational performance",
  "IE-C11": "IE-C11 — If fault-tree IE modelling is used, SY-A fault-tree rules applied and HFE contributions included",
  "IE-C12": "IE-C12 — If fault-tree IE modelling is used, methods produce a failure frequency, with DA and HRA inputs",
  "IE-C13": "IE-C13 — Control-room operator contribution to IE frequency estimated (split fractions where mixed)",
  "IE-C14": "IE-C14 — Relevant failure-plus-unavailability combinations included in IE fault-tree models",
  "IE-C15": "IE-C15 — Plant/design-specific information used in assessing and quantifying recovery actions",
  "IE-C16": "IE-C16 — Plant/design-specific results compared with generic data as a reasonableness check",
  "IE-C17": "IE-C17 — Rare initiating events use industry generic data, augmented for plant/design-specific features",
  "IE-C18": "IE-C18 — Interfacing-system RCB-breach frequency reflects pathway configuration, interlocks, tests and isolation",
  "IE-C19": "IE-C19 — Mean value and an uncertainty distribution provided for risk-significant initiators (CC-II)",
  "IE-D1":  "IE-D1 — IE process documented (inputs, methods, results) with full SR traceability",
  "IE-D2":  "IE-D2 — Model-uncertainty sources, assumptions & alternatives documented (IE-A17)",
  "IE-D3":  "IE-D3 — Pre-operational: assumptions & limitations from missing as-built detail documented",
};
