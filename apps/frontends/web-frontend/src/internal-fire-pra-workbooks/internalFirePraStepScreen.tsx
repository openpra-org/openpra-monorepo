...
function InternalFireInterfacesSection({ onEdit }: { onEdit: (interfaceIndex: number, transferIndex: number) => void }): JSX.Element {
  ...
  return <div className="poscard">
    <div className="poscard__head"><div className="ssection__heading"><h3 className="poscard__title">Interfaces</h3><InfoButton label="About Interfaces">Use this section to see what technical data Internal Fire PRA receives from other PRA technical elements and what controlled results it sends to Event Sequence Quantification and Risk Integration. Internal Fire subelement traceability is managed elsewhere and is not shown as a technical-element interface. Select a tab to inspect the actual transferred records.</InfoButton></div></div>
