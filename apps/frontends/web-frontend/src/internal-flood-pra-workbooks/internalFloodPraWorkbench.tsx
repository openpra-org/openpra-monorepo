...
function Screen({ id, actions, renderApprovalTable, renderSignCard, renderRoster }: { id: string; actions?: InternalFloodWorkflowActions; renderApprovalTable?: () => ReactNode; renderSignCard?: () => ReactNode; renderRoster?: () => ReactNode }): JSX.Element {
  switch (id) {
    ...
    case "risk-integration": return <RiskIntegrationScreen />; case "draft": return <DraftScreen actions={actions} />; case "review": return <ReviewScreen actions={actions} renderRoster={renderRoster} />;
    case "approval": return <ApprovalScreen actions={actions} renderApprovalTable={renderApprovalTable} renderSignCard={renderSignCard} />; default: return <AnalysisBasisScreen />;
  }
}
