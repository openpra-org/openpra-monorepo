...
export const patchInternalFloodPraWorkbook = (workbookId: string, mef: InternalFloodPRA): Promise<InternalFloodPraWorkbookResponse> => patchJson(`/api/internal-flood-pra-workbooks/${workbookId}`, { mef });
