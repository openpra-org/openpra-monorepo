  ...
  return <div className="posgen">
    ...
    <div className="posgen__side">
      <div className="posgen__readout">
        <WorkbookSectionHeading title="Conformance check" description="Summarize whether the workbook satisfies the applicable Internal Flood supporting requirements for the selected plant stage and capability-category target." className="posgen__readout-h" />
