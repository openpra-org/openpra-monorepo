...
function MsDocumentsCard({ workbookId, canEdit }: { workbookId: string; canEdit: boolean }): JSX.Element {
  const [docs, setDocs] = useState<MsDocumentEntry[] | null>(null);
  ...
  return (
    <div className="poscard">
      ...
      <p className="poscard__sub">The release-category definitions, the source and barrier inventory, the depletion calculation, the transport records, the aerosol study and the uncertainty basis that support this analysis.</p>
