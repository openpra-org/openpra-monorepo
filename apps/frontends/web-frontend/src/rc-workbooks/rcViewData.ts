...
const RC_SR_META: Record<string, string> = {
  "RCRE-A1": "Site fork",
  "RCRE-A2": "Release inputs",
  "RCRE-B2": "Evaluation scope",
  "RCPA-A1": "Protective actions",
  "RCPA-A4": "Population cohorts",
  "RCPA-A5": "Judgment SR",
  "RCPA-A9": "Evacuation delay",
  "RCPA-A11": "Cross-hazard",
  "RCME-A1": "Judgment SR",
  "RCME-A3": "Data recovery review",
  "RCAD-B2": "Dispersion comparison",
  "RCAD-C2": "Credit fence",
  "RCDO-A1": "Exposure pathways",
  "RCEC-A1": "Cost categories",
  "RCQ-A1": "Code demonstration",
  "RCQ-A3": "Sequence families",
  "RCQ-B2": "Judgment SR",
  "RCQ-B3": "RI handshake",
  "RCQ-C1": "Uncertainty sources",
};
