...
export const EventSequenceAnalysisSchema = z.object({
  ...
  keySafetyFunctions: z.array(z.object({
    id: z.string(),
    name: z.string(),
    description: z.string(),
    supportingSystems: z.array(z.string()),
    successCriteriaId: z.string().optional(),
  })),
  ...
  dynamicRuns: z.array(z.object({
    ...
    esdNodes: z.record(z.string(), z.object({
      id: z.string(),
      condition: z.string(),
      challengedFunctionId: z.string().optional(),
