...
const explorerEnabled = !(
  process.env.DOCS_ENABLE_SRC_EXPLORER === '0' ||
  process.env.DOCS_ENABLE_SRC_EXPLORER === 'false'
);
...
export default defineConfig({
  ...
  head: [
    [
      'link',
      { rel: 'icon', type: 'image/png', href: `${base}openpra-logo.png` },
    ],
  ],
  ...
  themeConfig: {
    ...
    socialLinks: [
      {
        icon: 'github',
        link: 'https://github.com/openpra-org/openpra-monorepo',
      },
    ],
    // Footer
    footer: {
      ...
      copyright:
        'Copyright © 2019-present <a href="https://openpra.org">OpenPRA ORG Inc.</a>',
    },
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
            ...
            : []),
          {
            ...
            link: '/api/ts/model-generator/README.html',
          },
          {
            text: 'Engine scram-node (TS)',
            link: '/api/ts/scram-node/README.html',
          },
          {
            text: 'Web Backend (NestJS)',
            link: '/api/ts/web-backend/README.html',
          },
          {
            text: 'Job Broker (microservice)',
            link: '/api/ts/job-broker/README.html',
          },
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: 'Namespaces',
            link: '/api/cpp-doxybook2/index_namespaces.html',
          },
      ...
      '/mef-elements/': [
        {
          ...
          items: (() => {
            ...
            const mefRoot = path.resolve(
              repoRoot,
              'packages/docs-md/mef-elements',
            );
            const order: Array<{ slug: string; text: string }> = [
              {
                slug: 'plant-operating-states-analysis',
                text: 'Plant Operating States Analysis',
              },
              {
                slug: 'initiating-event-analysis',
                text: 'Initiating Event Analysis',
              },
              {
                slug: 'event-sequence-analysis',
                text: 'Event Sequence Analysis',
              },
              ...
              {
                slug: 'event-sequence-quantification',
                text: 'Event Sequence Quantification',
              },
              {
                slug: 'mechanistic-source-term',
                text: 'Mechanistic Source Term Analysis',
              },
              {
                slug: 'radiological-consequence-analysis',
      ...
      '/api/ts/web-editor/': [
        {
          ...
          items: [
            ...
            ...(explorerEnabled
              ? [
                  {
                    text: 'Explore src/ (by folder)',
                    link: '/api/ts/web-editor/_explore/index.html',
                  },
                ]
              : []),
          ],
          ...
          items: [
            ...
            ...(explorerEnabled
              ? [
                  {
                    text: 'Explore src/ (by folder)',
                    link: '/api/ts/shared-sdk/_explore/index.html',
                  },
                ]
              : []),
          ],
          ...
          items: [
            ...
            ...(explorerEnabled
              ? [
                  {
                    text: 'Explore src/ (by folder)',
                    link: '/api/ts/shared-types/_explore/index.html',
                  },
                ]
              : []),
          ],
          ...
          items: [
            ...
            ...(explorerEnabled
              ? [
                  {
                    text: 'Explore src/ (by folder)',
                    link: '/api/ts/mef-types/_explore/index.html',
                  },
                ]
              : []),
          ],
                ...
                items: [
                  ...
                  ...(explorerEnabled
                    ? [
                        {
                          text: 'Explore src/ (by folder)',
                          link: '/api/ts/mef-schema/_explore/index.html',
                        },
                      ]
                    : []),
                ],
          ...
          items: [
            ...
            ...(explorerEnabled
              ? [
                  {
                    text: 'Explore src/ (by folder)',
                    link: '/api/ts/model-generator/_explore/index.html',
                  },
                ]
              : []),
          ],
          ...
          items: [
            ...
            ...(explorerEnabled
              ? [
                  {
                    text: 'Explore src/ (by folder)',
                    link: '/api/ts/web-backend/_explore/index.html',
                  },
                ]
              : []),
          ],
          ...
          items: [
            ...
            ...(explorerEnabled
              ? [
                  {
                    text: 'Explore src/ (by folder)',
                    link: '/api/ts/job-broker/_explore/index.html',
                  },
                ]
              : []),
          ],
    ...
    plugins: [
      // Pre-render version tokens on Stack pages so we can keep markdown.html=false safely
      {
        ...
        transform(code, id) {
          ...
          if (
            !/\/stack\/(frontend-overview|backend-overview|engine-overview)\.md$/.test(
              idPosix,
            )
          ) {
            return null;
          ...
          if (idPosix.endsWith('/stack/frontend-overview.md')) {
            const fePkgPath = path.resolve(
              repoRoot,
              'packages/frontend/web-editor/package.json',
            );
            ...
            replacements['typescript'] =
              ...
              fePkg?.devDependencies?.typescript ??
              'N/A';
            replacements['eui'] =
              fePkg?.dependencies?.['@elastic/eui'] ?? 'N/A';
            replacements['reactRouter'] =
              fePkg?.dependencies?.['react-router-dom'] ?? 'N/A';
            ...
            const bePkgPath = path.resolve(
              repoRoot,
              'packages/web-backend/package.json',
            );
            const bePkg = fs.existsSync(bePkgPath) ? readJson(bePkgPath) : {};
            replacements['nest'] =
              bePkg?.dependencies?.['@nestjs/core'] ??
              bePkg?.dependencies?.['@nestjs/common'] ??
              'N/A';
            replacements['mongoose'] = bePkg?.dependencies?.mongoose ?? 'N/A';
            replacements['typescript'] =
              rootPkg?.devDependencies?.typescript ?? 'N/A';
            replacements['nxVersion'] = rootPkg?.devDependencies?.nx ?? 'N/A';
          } else if (idPosix.endsWith('/stack/engine-overview.md')) {
            const enPkgPath = path.resolve(
              repoRoot,
              'packages/engine/scram-node/package.json',
            );
            const enPkg = fs.existsSync(enPkgPath) ? readJson(enPkgPath) : {};
            replacements['cmakeJs'] =
              enPkg?.dependencies?.['cmake-js'] ?? 'N/A';
            replacements['nodeAddonApi'] =
              enPkg?.dependencies?.['node-addon-api'] ?? 'N/A';
            replacements['nxVersion'] = rootPkg?.devDependencies?.nx ?? 'N/A';
          }
