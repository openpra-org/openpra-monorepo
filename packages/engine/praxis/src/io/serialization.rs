...
use crate::algorithms::bdd::BddStats;
...
pub struct AnalysisCheckpoint {
    ...
    /// BDD statistics (if BDD algorithm used)
...
impl AnalysisCheckpoint {
    ...
    /// Add BDD statistics to checkpoint
    pub fn with_bdd_stats(mut self, stats: BddStats) -> Self {
        self.bdd_stats = Some(stats);
        self
    }
}
