...
mod xml_error_tests {
    ...
    #[test]
    fn test_parse_error_without_element() {
    ...
    #[test]
    fn test_parse_error_with_element() {
        let err = XmlError::Parse {
    ...
    #[test]
    fn test_validity_error_minimal() {
    ...
    #[test]
    fn test_validity_error_with_element() {
        let err = XmlError::Validity {
    ...
    #[test]
    fn test_validity_error_with_element_and_attribute() {
        let err = XmlError::Validity {
