...
const ContextAddButton = (): JSX.Element => {
  ...
  if (location.startsWith("/internal-events")) {
    ...
    if (location.endsWith("/event-sequence-diagrams")) return <CreateEventSequenceDiagramButton />;
    if (location.endsWith("/event-trees")) return <CreateEventTreeButton />;
    if (location.endsWith("/bayesian-networks")) return <CreateBayesianNetworkButton />;
    ...
    if (location === "/internal-hazards") return <CreateInternalHazardsButton />;
    if (location.endsWith("/initiating-events")) return <CreateInitiatingEventButton />;
    if (location.endsWith("/event-sequence-diagrams")) return <CreateEventSequenceDiagramButton />;
    if (location.endsWith("/event-trees")) return <CreateEventTreeButton />;
    if (location.endsWith("/bayesian-networks")) return <CreateBayesianNetworkButton />;
