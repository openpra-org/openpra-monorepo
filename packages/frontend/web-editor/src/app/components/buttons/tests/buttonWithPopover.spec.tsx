...
describe(ButtonWithPopover, () => {
    it('Checks the button with icon', () => {
        render(<BrowserRouter><ButtonWithClosablePopover closeProp="onCancel" isIcon iconType={"bars"}/></BrowserRouter>);
    ...
    it('Checks the button with text', () => {
        render(<BrowserRouter><ButtonWithClosablePopover closeProp="onCancel"/></BrowserRouter>);
