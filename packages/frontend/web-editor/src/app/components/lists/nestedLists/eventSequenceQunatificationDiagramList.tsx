...
export default function EventSequenceQuantificationDiagramList() {
  return (
    <NestedModelList
      getNestedEndpoint={
        NestedModelApiManager.getEventSequenceQuantificationDiagram
      }
      deleteNestedEndpoint={
        NestedModelApiManager.deleteEventSequenceQuantificationDiagram
      }
      patchNestedEndpoint={
        NestedModelApiManager.patchEventSequenceQuantificationDiagramLabel
      }
