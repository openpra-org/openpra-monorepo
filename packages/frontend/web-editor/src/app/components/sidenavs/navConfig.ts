...
const IE: NavNode = {
  ...
  expanded: true,
  items: [
    { id: "initiating-events", name: "Initiating Events", path: "initiating-events", iconType: "shard" },
    { id: "initiating-events-model-view", name: "Model View", path: "initiating-events-model-view", iconType: "shard" },
    {
...
const SC: NavNode = {
  ...
  expanded: true,
  items: [
    { id: "success-criteria", name: "Success Criteria", path: "success-criteria", iconType: "stats" },
