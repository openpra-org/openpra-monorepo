...
import { RFState, useStore } from "../../store/masterLogicDiagramStore";
...
import { allToasts, initialEdges, initialNodes } from "../../../utils/masterLogicDiagramData";
import { exitGrayedState, GenerateUUID, isSubgraphGrayed } from "../../../utils/treeUtils";
import { MasterLogicDiagramNodeTypes } from "../../components/treeNodes/masterLogicDiagramNodes/masterLogicDiagramNodeType";
import { EdgeTypes } from "../../components/treeEdges/masterLogicDiagramEdges/masterLogicDiagramEdgeType";
...
function ReactFlowPro(): JSX.Element {
  ...
  return isLoading ? (
    ...
    <ReactFlow
      ...
      fitView
      nodeTypes={MasterLogicDiagramNodeTypes}
      edgeTypes={EdgeTypes}
...
export function MasterLogicDiagramEditor(): JSX.Element {
  return (
    <ReactFlowProvider>
      <ReactFlowPro />
    </ReactFlowProvider>
