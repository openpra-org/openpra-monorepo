                ...
                <EuiForm>
                  {getMergedColumns
                    ...
                    .map((column) => {
                      ...
                      let valueForField =
                        selectedRowData[customColumn.id] || "";
                        ...
                        >
                          {customColumn.inputType === "dropdown" ? (
                            <EuiSelect
                              ...
                              onChange={(e) => {
                                updateFieldInData(
                                  customColumn.id as keyof DataRow,
                                  e.target.value,
                                );
                              }}
                            />
...
export const OperatingStateAnalysis = (): JSX.Element => {
  return <App />;
};
