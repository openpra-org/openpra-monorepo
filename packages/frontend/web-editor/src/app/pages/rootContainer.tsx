...
const RootContainer = (): ReactElement => {
  ...
  if (!isLoggedIn && (location.pathname === "/" || location.pathname.startsWith("/invite/") || location.pathname.startsWith("/password-reset") || location.pathname.startsWith("/create-new-password"))) {
    return <Outlet />;
  } else {
