...
import InitiatingEventsFaultTrees from "../fullScopePages/initiatingEventsFaultTree";
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="initiating-event-fault-tree/*" element={<InitiatingEventsFaultTrees />} />
