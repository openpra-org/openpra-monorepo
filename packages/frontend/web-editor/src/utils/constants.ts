...
export const MASTER_LOGIC_DIAGRAM_NODE_WIDTH = 250;
export const MASTER_LOGIC_DIAGRAM_NODE_HEIGHT = 165;
export const MASTER_LOGIC_DIAGRAM_NODE_SEPARATION = 0.75;
