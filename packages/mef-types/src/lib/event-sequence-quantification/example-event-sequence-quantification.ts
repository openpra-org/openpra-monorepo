...
export const EventSequenceQuantificationExample = {
  ...
  eventSequenceFamilies: {
    'ESF-LOCA-SMALL': {
      ...
      description:
        'Event sequences initiated by small loss of coolant accidents',
      ...
      groupingCriteria:
        'Similar initiating event and mitigating system requirements',
  ...
  quantificationMethods: {
    ...
    truncation: {
      ...
      convergenceDemonstration:
        'Frequency stabilized with less than 0.5% change for the final two truncation values',
    },
    recoveryActionHandling:
      'Explicit modeling in event trees with dependencies',
    postInitiatorHFEHandling:
      'Modeled using HRA calculator with dependency factors',
  },
  modelIntegration: {
    ...
    integrationVerification:
      'Verified through manual checks of selected sequences and automated software verification',
    integrationIssues: [
      {
        description:
          'Interface issue between event tree and fault tree software',
  ...
  dependencyTreatment: {
    dependenciesByType: {
      [DependencyType.FUNCTIONAL]: {
        treatmentDescription:
          'Modeled through explicit system fault tree linking',
      ...
      [DependencyType.PHYSICAL]: {
        treatmentDescription:
          'Spatial dependencies addressed through common cause failure groups',
      ...
      [DependencyType.HUMAN]: {
        treatmentDescription:
          'Dependencies between actions modeled using HRA dependency factors',
      ...
      [DependencyType.PHENOMENOLOGICAL]: {
        treatmentDescription:
          'Phenomenological dependencies modeled with physics-based models',
      ...
      [DependencyType.COMMON_CAUSE]: {
        treatmentDescription:
          'Common cause failures modeled with alpha factor method',
    ...
    commonCauseFailures: {
      ...
      parameterBasis:
        'Industry data with Bayesian update using plant-specific experience',
    ...
    phenomenologicalDependencies: {
      ...
      basisForApproach:
        'Thermal-hydraulic analyses validated against experiments',
    },
    recoveryActionDependencies: {
      ...
      modelingApproach:
        'Time-based non-recovery probability curves with dependency factors',
    },
  },
  logicalChallenges: {
    circularLogic: {
      'CIRC-001': {
        id: 'CIRC-001',
        description:
          'Circular dependency between electrical power system and service water system',
        involvedElementIds: ['SYS-EPS', 'SYS-SWS'],
        detectionMethod: 'Automated detection using fault tree analyzer',
        resolutionMethod:
          CircularLogicResolutionMethod.CONDITIONAL_SPLIT_FRACTIONS,
        resolutionDescription:
          'Used conditional split fractions to break the loop',
  ...
  barrierTreatment: {
    ...
    barrierChallengesTreatment:
      'Phenomenological analysis using validated codes',
  ...
  documentation: {
    ...
    processDescription:
      'Event sequences were quantified using fault tree linking with RISKMAN software',
    inputs: [
    ...
    resultsSummary:
      'Total frequency of all sequences is 2.3E-5 per year with Small LOCA and LOOP sequences dominating',
    nonRecoveryTermsProcess:
      'Recovery actions were modeled using time-based non-recovery curves',
    cutsetReviewProcess:
      'Top 100 cutsets were reviewed by a multi-disciplinary team',
    quantificationProcess:
      'Full event tree/fault tree linking with circular logic resolution',
    truncationProcess:
      'Progressive truncation from 1E-8 to 1E-12 to demonstrate convergence',
    familyFrequencies: {
    ...
    eventSequencesAndBinning:
      'Sequences were binned based on initiating event, system response, and end state',
    dependenciesTreatment:
      'Functional, physical, and human dependencies were modeled explicitly',
    radionuclideBarrierTreatment:
      'Barrier failures were integrated into the event sequence model',
    mutuallyExclusiveEventsTreatment:
      'Boolean reduction with explicit removal of impossible combinations',
    asymmetriesInModeling:
      'Train-specific modeling for key systems to capture asymmetric dependencies',
    computerCodeUsed: 'RISKMAN 3.2 with CAFTA 6.0 integration',
    intermediateStatesApproach:
      'Plant damage states used as intermediate end states for Level 2 analysis',
    riskSignificanceDrivers:
      'Sequences involving loss of all AC power and small LOCAs with injection failure',
    comparisonToSimilarPlants:
      'Results are consistent with similar plants within expected variation',
  },
    ...
    modelUncertaintySources: [
      {
        sourceId: 'MU-001',
        description:
          'Uncertainty in success criteria for high pressure injection',
    ...
    reasonableAlternatives: [
      {
        ...
        reasonNotSelected:
          'Thermal-hydraulic analysis supports current criteria',
