    ...
    basicEventProbabilityModels: [
      {
        ...
        model: "LOGNORMAL",
        justification: "Lognormal distribution selected based on industry standard practices for continuous operation components with multiplicative failure mechanisms"
      },
      {
        basicEventId: "BE-EBRII-PSP-FS-001", // Failure to start basic event
        model: "BETA",
        justification: "Beta distribution selected for demand-based failure mode to properly model uncertainty with limited data"
      }
    ],
    ...
    genericParameterSources: [
      {
        ...
        source: "NUREG/CR-6928, Industry-Average Performance for Components and Initiating Events at U.S. Commercial Nuclear Power Plants",
    ...
    dataExclusionJustifications: [
      {
        ...
        justification: "Events occurred during non-standard operating conditions not representative of normal operation"
      }
    ],
    ...
    ccfProbabilityBasis: [
      {
        ...
        mappingJustification: "Alpha factors derived from light water reactor experience adjusted for liquid metal environment based on expert judgment"
      }
    ],
    ...
    bayesianPriorRationales: [
      {
        ...
        rationale: "Prior based on generic liquid metal pump failure rates with wide uncertainty to accommodate limited industry experience"
      }
    ],
    ...
    parameterEstimates: [
      {
        parameterId: "PARAM-EBRII-PSP-FR-001",
        estimate: 1.2e-5,
        uncertaintyCharacterization: "Lognormal distribution with 5th percentile 2.5e-6, 95th percentile 5.8e-5, error factor 4.8"
      },
      {
        parameterId: "PARAM-EBRII-PSP-FS-001",
        estimate: 3.4e-3,
        uncertaintyCharacterization: "Beta distribution with α=2.5, β=732, 5th percentile 6.7e-4, 95th percentile 8.2e-3"
      }
    ],
    ...
    operatingStateDataJustifications: [
      {
        parameterId: "PARAM-EBRII-PSP-FR-001",
        operatingState: "POS-FULL-POWER-100",
        justification: "Full power operation provides most representative conditions for primary pump failure rates as pumps operate at design flow rates and temperatures"
      }
    ],
    ...
    genericParameterRationales: [
      {
        ...
        rationale: "Generic parameters used for startup and shutdown states due to insufficient plant-specific data for these infrequent operating states"
      }
    ],
    ...
    componentGroupingDocumentation: [
      {
        ...
        groupingCriteria: "Primary sodium pumps grouped based on similar design, operational characteristics, and environment",
        outlierIdentificationMethodology: "Statistical hypothesis testing comparing failure rates across similar components with 95% confidence threshold",
        outlierExclusionJustifications: [
          {
            ...
            detailedJustification: "Secondary loop pump operates at lower temperature and has different seal design, resulting in significantly different failure characteristics",
    ...
    uncertaintySources: [
      {
        ...
        impact: "Introduces uncertainty in applicability of parameter estimates to current sodium-cooled fast reactor designs",
    ...
    relatedAssumptions: [
      {
        ...
        basis: "Design principles for electromagnetic sodium pumps have not fundamentally changed, though materials and manufacturing have improved",
        applicableParameters: ["PARAM-EBRII-PSP-FR-001"]
      },
      {
        assumption: "Common cause failure mechanisms for sodium pumps are similar to those of light water reactor pumps",
        basis: "While fluid properties differ, fundamental CCF mechanisms like design errors, manufacturing defects, and maintenance errors remain similar",
    ...
    reasonableAlternatives: [
      {
        ...
        reasonNotSelected: "Lognormal better characterizes the uncertainty in the estimated parameters given the limited data",
        applicableParameters: ["PARAM-EBRII-PSP-FR-001"]
      },
      {
