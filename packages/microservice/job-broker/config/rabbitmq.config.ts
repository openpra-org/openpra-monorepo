...
export const getRabbitMQConfig = () => ({
  ...
  [RabbitMQConfigKeys.EXECUTABLE_STORAGE_QUEUE_NAME]:
    process.env.EXECUTABLE_STORAGE_QUEUE_NAME ?? "executable_result_storage_queue",
  ...
  [RabbitMQConfigKeys.QUANT_STORAGE_QUEUE_NAME]:
    process.env.QUANT_STORAGE_QUEUE_NAME ?? "quantification_result_storage_queue",
});
