...
describe("ScramController", () => {
  ...
  describe("getQuantifiedReports", () => {
    ...
    it("should throw NotFoundException on error", async () => {
      ...
      await expect(controller.getQuantifiedReports()).rejects.toThrow(NotFoundException);
    });
  });
  describe("getInputData", () => {
    ...
    it("should throw NotFoundException on error", async () => {
      ...
      await expect(controller.getInputData("input-123")).rejects.toThrow(NotFoundException);
    });
  });
  describe("getJobStats", () => {
    ...
    it("should throw NotFoundException on error", async () => {
      ...
      await expect(controller.getJobStats("job-123")).rejects.toThrow(NotFoundException);
    });
  });
});
