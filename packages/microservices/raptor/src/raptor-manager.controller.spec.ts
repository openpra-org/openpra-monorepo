...
describe("RaptorManagerController", () => {
  ...
  describe("getProcessingJobs", () => {
    ...
    it("should throw NotFoundException on error", async () => {
      ...
      await expect(controller.getProcessingJobs()).rejects.toThrow(NotFoundException);
    });
  });
  describe("getRunningJobs", () => {
    ...
    it("should throw NotFoundException on error", async () => {
      ...
      await expect(controller.getRunningJobs()).rejects.toThrow(NotFoundException);
    });
  });
  describe("getCompletedJobs", () => {
    ...
    it("should throw NotFoundException on error", async () => {
      ...
      await expect(controller.getCompletedJobs()).rejects.toThrow(NotFoundException);
    });
  });
  describe("getPartialJobs", () => {
    ...
    it("should throw NotFoundException on error", async () => {
      ...
      await expect(controller.getPartialJobs()).rejects.toThrow(NotFoundException);
    });
  });
  describe("getFailedJobs", () => {
    ...
    it("should throw NotFoundException on error", async () => {
      ...
      await expect(controller.getFailedJobs()).rejects.toThrow(NotFoundException);
    });
  });
  describe("getExample", () => {
    ...
    it("should return example 1 (fault tree, non-distributed, BDD)", () => {
      ...
      expect(readFileSync).toHaveBeenCalledWith(expect.stringContaining("JSON/chinese.json"), "utf-8");
    });
    it("should return example 2 (event tree, distributed sequences)", () => {
      const result = controller.getExample("2");
      expect(result).toEqual(mockExampleData);
      expect(readFileSync).toHaveBeenCalledWith(expect.stringContaining("JSON/demo_gas_leak.json"), "utf-8");
    });
    it("should return example 3 (fault tree, adaptive)", () => {
      const result = controller.getExample("3");
      expect(result).toEqual(mockExampleData);
      expect(readFileSync).toHaveBeenCalledWith(expect.stringContaining("JSON/chinese_adaptive.json"), "utf-8");
    });
    it("should return example 4 (event tree, adaptive)", () => {
      const result = controller.getExample("4");
      expect(result).toEqual(mockExampleData);
      expect(readFileSync).toHaveBeenCalledWith(expect.stringContaining("Adaptive/demo_gas_leak.json"), "utf-8");
    });
    it("should throw NotFoundException for invalid example ID", () => {
      expect(() => controller.getExample("5")).toThrow(NotFoundException);
      expect(() => controller.getExample("5")).toThrow("Example ID must be 1, 2, 3, or 4. Received: 5");
    });
    it("should throw NotFoundException for non-numeric example ID", () => {
      ...
      expect(() => controller.getExample("invalid")).toThrow("Example ID must be 1, 2, 3, or 4. Received: invalid");
    });
    it("should throw NotFoundException when file read fails", () => {
      ...
      expect(() => controller.getExample("1")).toThrow("Unable to load example 1: File not found");
    });
