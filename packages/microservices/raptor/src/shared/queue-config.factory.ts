  ...
  public createDistributedSequencesJobQueueConfig(): QueueConfig {
    return {
      ...
      deadLetter: {
        ...
        durable: Boolean(
          this.configSvc.getOrThrow<boolean>(EnvVarKeys.DISTRIBUTED_SEQUENCES_JOB_DEAD_LETTER_QUEUE_DURABLE),
        ),
      },
    };
  }
  public createAdaptiveSequencesJobQueueConfig(): QueueConfig {
    return {
      ...
      deadLetter: {
        ...
        durable: Boolean(
          this.configSvc.getOrThrow<boolean>(EnvVarKeys.ADAPTIVE_SEQUENCES_JOB_DEAD_LETTER_QUEUE_DURABLE),
        ),
      },
    };
  }
