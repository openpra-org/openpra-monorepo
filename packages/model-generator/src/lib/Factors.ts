/**
 * @file Factors.ts
 * @brief This file contains the Factors class which is used to manage and calculate various factors related to a fault tree.
...
/**
 * @class Factors
 * @brief This class is used to manage and calculate various factors related to a fault tree.
 * @details The Factors class provides methods to set and get various factors such as the number of basic events, house
 * events, ccf groups, etc. It also provides methods to calculate derived factors and to sample gate operators and the
 * number of arguments for a given gate type.
 */
export default class Factors {
  ...
  /**
   * @brief Sets the probability boundaries for basic events.
   * @details This method is used to set the minimum and maximum probabilities for basic events.
  ...
  /**
   * @brief Sets the factors for the number of common events.
   * @details This method is used to set the factors for the number of common basic events and common gates per gate,
   * and the average number of parents for common basic events and common gates.
  ...
  /**
   * @brief Sets the size factors.
   * @details This method is used to set the size factors such as the average number of arguments for gates, the number
   * of basic events, house events, ccf groups, etc.
  ...
  /**
   * @brief Calculates the maximum number of arguments for sampling.
   * @details This method is used to calculate the maximum number of arguments for sampling. The result may have a
   * fractional part that must be adjusted in sampling accordingly.
   * @param numArgs The average number of arguments for gates.
  ...
  private static calculateMaxArgs(numArgs: number, weights: number[]): number {
    ...
    return (2 * numArgs - varContrib.reduce((a, b) => a + b, 0) - 2 * constContrib.reduce((a, b) => a + b, 0)) / varWeights.reduce((a, b) => a + b, 0);
  }

  /**
   * @brief Calculates any derived factors from the setup.
   * @details This method is used to calculate any derived factors from the setup. This function must be called after
   * all public factors are initialized.
   */
  calculate(): void {
  ...
  /**
   * @brief Provides weights for gate types.
   * @details This method is used to get the weights for gate types.
  ...
  /**
   * @brief Updates gate type weights.
   * @details This method is used to update the weights for gate types. The weights must have the same order as in
   * OPERATORS list. If weights for some operators are missing, they are assumed to be 0.
  ...
  /**
   * @brief Samples the gate operator.
   * @details This method is used to sample a gate operator randomly.
  ...
  /**
   * @brief Randomly selects the number of arguments for the given gate type.
   * @details This method is used to randomly select the number of arguments for a given gate type. This function has a
   * side effect. It sets k_num for the K/N type of gates depending on the number of arguments.
  ...
  /**
   * @brief Returns the percentage of gates that should be in arguments.
   * @details This method is used to get the percentage of gates that should be in arguments.
  ...
  /**
   * @brief Approximates the number of gates in the resulting fault tree.
   * @details This method is used to approximate the number of gates in the resulting fault tree. This is an estimate of
   * the number of gates needed to initialize the fault tree with the given number of basic events and fault tree properties.
  ...
  /**
   * @brief Estimates the number of common basic events.
   * @details This method is used to estimate the number of common basic events. These common basic events must be
   * chosen from the total number of basic events in order to ensure the correct average number of parents.
  ...
  /**
   * @brief Estimates the number of common gates.
   * @details This method is used to estimate the number of common gates. These common gates must be chosen from the
   * total number of gates in order to ensure the correct average number of parents.
   * @param numGate The total number of gates in the future fault tree
