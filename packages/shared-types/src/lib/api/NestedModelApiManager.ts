...
export default class NestedModelApiManager {
  ...
  // Risk Integration
static async postRiskIntegration(data: NestedModelJSON, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback) : Promise<NestedModel> {
  const returnResponse = await NestedModelApiManager.post(`${RISK_INTEGRATION_ENDPOINT}/`, JSON.stringify(data), override, onSuccessCallback, onFailCallback);
  const body = {
      modelId: await TypedModelApiManager.getCurrentModelId(),
      nestedId: await NestedModelApiManager.getPreviousCounterValue(),
...
static async postRadiologicalConsequenceAnalysis(data: NestedModelJSON, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback) : Promise<NestedModel> {
  const returnResponse = await NestedModelApiManager.post(`${RADIOLOGICAL_CONSEQUENCE_ANALYSIS_ENDPOINT}/`, JSON.stringify(data), override, onSuccessCallback, onFailCallback);
  const body = {
      modelId: await TypedModelApiManager.getCurrentModelId(),
      nestedId: await NestedModelApiManager.getPreviousCounterValue(),
...
static async postMechanisticSourceTerm(data: NestedModelJSON, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback) : Promise<NestedModel> {
  const returnResponse = await NestedModelApiManager.post(`${MECHANISTIC_SOURCE_TERM_ENDPOINT}/`, JSON.stringify(data), override, onSuccessCallback, onFailCallback);
  const body = {
      modelId: await TypedModelApiManager.getCurrentModelId(),
      nestedId: await NestedModelApiManager.getPreviousCounterValue(),
...
static async postEventSequenceQuantificationDiagram(data: NestedModelJSON, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback) : Promise<NestedModel> {
  const returnResponse = await NestedModelApiManager.post(`${EVENT_SEQUENCE_QUANTIFICATION_DIAGRAM_ENDPOINT}/`, JSON.stringify(data), override, onSuccessCallback, onFailCallback);
  const body = {
      modelId: await TypedModelApiManager.getCurrentModelId(),
      nestedId: await NestedModelApiManager.getPreviousCounterValue(),
...
// Data Analysis
static async postDataAnalysis(data: NestedModelJSON, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback) : Promise<NestedModel> {
  const returnResponse = await NestedModelApiManager.post(`${DATA_ANALYSIS_ENDPOINT}/`, JSON.stringify(data), override, onSuccessCallback, onFailCallback);
  const body = {
      modelId: await TypedModelApiManager.getCurrentModelId(),
      nestedId: await NestedModelApiManager.getPreviousCounterValue(),
...
static async postHumanReliabilityAnalysis(data: NestedModelJSON, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback) : Promise<NestedModel> {
  const returnResponse = await NestedModelApiManager.post(`${HUMAN_RELIABILITY_ANALYSIS_ENDPOINT}/`, JSON.stringify(data), override, onSuccessCallback, onFailCallback);
  const body = {
      modelId: await TypedModelApiManager.getCurrentModelId(),
      nestedId: await NestedModelApiManager.getPreviousCounterValue(),
...
// Systems Analysis
static async postSystemsAnalysis(data: NestedModelJSON, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback) : Promise<NestedModel> {
  const returnResponse = await NestedModelApiManager.post(`${SYSTEMS_ANALYSIS_ENDPOINT}/`, JSON.stringify(data), override, onSuccessCallback, onFailCallback);
  const body = {
      modelId: await TypedModelApiManager.getCurrentModelId(),
      nestedId: await NestedModelApiManager.getPreviousCounterValue(),
...
// Success Criteria
static async postSuccessCriteria(data: NestedModelJSON, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback) : Promise<NestedModel> {
  const returnResponse = await NestedModelApiManager.post(`${SUCCESS_CRITERIA_ENDPOINT}/`, JSON.stringify(data), override, onSuccessCallback, onFailCallback);
  const body = {
      modelId: await TypedModelApiManager.getCurrentModelId(),
      nestedId: await NestedModelApiManager.getPreviousCounterValue(),
...
static async postEventSequenceAnalysis(data: NestedModelJSON, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback) : Promise<NestedModel> {
  const returnResponse = await NestedModelApiManager.post(`${EVENT_SEQUENCE_ANALYSIS_ENDPOINT}/`, JSON.stringify(data), override, onSuccessCallback, onFailCallback);
  const body = {
      modelId: await TypedModelApiManager.getCurrentModelId(),
      nestedId: await NestedModelApiManager.getPreviousCounterValue(),
...
static async postOperatingStateAnalysis(data: NestedModelJSON, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback) : Promise<NestedModel> {
  const returnResponse = await NestedModelApiManager.post(`${OPERATING_STATE_ANALYSIS_ENDPOINT}/`, JSON.stringify(data), override, onSuccessCallback, onFailCallback);
  const body = {
      modelId: await TypedModelApiManager.getCurrentModelId(),
      nestedId: await NestedModelApiManager.getPreviousCounterValue(),
  ...
  // Risk Integration
static getRiskIntegration(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel[]> {
  return NestedModelApiManager.get(`${RISK_INTEGRATION_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback)
      .then((response) => { return response.json() as NestedModel[]; })
      .catch((error) => {
...
// Radiological Consequence Analysis
static getRadiologicalConsequenceAnalysis(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel[]> {
  return NestedModelApiManager.get(`${RADIOLOGICAL_CONSEQUENCE_ANALYSIS_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback)
      .then((response) => { return response.json() as NestedModel[]; })
      .catch((error) => {
          console.error('Error fetching Radiological Consequence Analysis:', error);
          throw error;
      });
}

// Mechanistic Source Term
static getMechanisticSourceTerm(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel[]> {
  return NestedModelApiManager.get(`${MECHANISTIC_SOURCE_TERM_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback)
      .then((response) => { return response.json() as NestedModel[]; })
      .catch((error) => {
          console.error('Error fetching Mechanistic Source Term analysis:', error);
          throw error;
      });
}

// Event Sequence Quantification Diagram
static getEventSequenceQuantificationDiagram(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel[]> {
  return NestedModelApiManager.get(`${EVENT_SEQUENCE_QUANTIFICATION_DIAGRAM_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback)
      .then((response) => { return response.json() as NestedModel[]; })
      .catch((error) => {
          console.error('Error fetching Event Sequence Quantification Diagram analysis:', error);
          throw error;
      });
}

// Data Analysis
static getDataAnalysis(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel[]> {
  return NestedModelApiManager.get(`${DATA_ANALYSIS_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback)
      .then((response) => { return response.json() as NestedModel[]; })
      .catch((error) => {
...
// Human Reliability Analysis
static getHumanReliabilityAnalysis(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel[]> {
  return NestedModelApiManager.get(`${HUMAN_RELIABILITY_ANALYSIS_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback)
      .then((response) => { return response.json() as NestedModel[]; })
      .catch((error) => {
...
// Systems Analysis
static getSystemsAnalysis(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel[]> {
  return NestedModelApiManager.get(`${SYSTEMS_ANALYSIS_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback)
      .then((response) => { return response.json() as NestedModel[]; })
      .catch((error) => {
...
// Success Criteria
static getSuccessCriteria(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel[]> {
  return NestedModelApiManager.get(`${SUCCESS_CRITERIA_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback)
      .then((response) => { return response.json() as NestedModel[]; })
      .catch((error) => {
...
// Event Sequence Analysis
static getEventSequenceAnalysis(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel[]> {
  return NestedModelApiManager.get(`${EVENT_SEQUENCE_ANALYSIS_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback)
      .then((response) => { return response.json() as NestedModel[]; })
      .catch((error) => {
...
// Operating State Analysis
static getOperatingStateAnalysis(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel[]> {
  return NestedModelApiManager.get(`${OPERATING_STATE_ANALYSIS_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback)
      .then((response) => { return response.json() as NestedModel[]; })
      .catch((error) => {
  ...
  // Risk Integration
  static patchRiskIntegrationLabel(id: number, data: LabelJSON, override: any = null, onSuccessCallback = TypedModelApiManager.defaultSuccessCallback, onFailCallback = TypedModelApiManager.defaultFailCallback): Promise<NestedModel> {
    return TypedModelApiManager.patch(`${RISK_INTEGRATION_ENDPOINT}/${id}`, JSON.stringify(data), override, onSuccessCallback, onFailCallback)
        .then((response) => {
            return response.json();
        });
  }
  ...
  // Radiological Consequence Analysis
  static patchRadiologicalConsequenceLabel(id: number, data: LabelJSON, override: any = null, onSuccessCallback = TypedModelApiManager.defaultSuccessCallback, onFailCallback = TypedModelApiManager.defaultFailCallback): Promise<NestedModel> {
    return TypedModelApiManager.patch(`${RADIOLOGICAL_CONSEQUENCE_ANALYSIS_ENDPOINT}/${id}`, JSON.stringify(data), override, onSuccessCallback, onFailCallback)
        .then((response) => {
            return response.json();
        });
  }
  ...
  // Mechanistic Source Term
  static patchMechanisticSourceTermLabel(id: number, data: LabelJSON, override: any = null, onSuccessCallback = TypedModelApiManager.defaultSuccessCallback, onFailCallback = TypedModelApiManager.defaultFailCallback): Promise<NestedModel> {
    return TypedModelApiManager.patch(`${MECHANISTIC_SOURCE_TERM_ENDPOINT}/${id}`, JSON.stringify(data), override, onSuccessCallback, onFailCallback)
        .then((response) => {
            return response.json();
        });
  }
  ...
  // Event Sequence Quantification Diagram
  static patchEventSequenceQuantificationDiagramLabel(id: number, data: LabelJSON, override: any = null, onSuccessCallback = TypedModelApiManager.defaultSuccessCallback, onFailCallback = TypedModelApiManager.defaultFailCallback): Promise<NestedModel> {
    return TypedModelApiManager.patch(`${EVENT_SEQUENCE_QUANTIFICATION_DIAGRAM_ENDPOINT}/${id}`, JSON.stringify(data), override, onSuccessCallback, onFailCallback)
        .then((response) => {
            return response.json();
        });
  }
  ...
  // Data Analysis
  static patchDataAnalysisLabel(id: number, data: LabelJSON, override: any = null, onSuccessCallback = TypedModelApiManager.defaultSuccessCallback, onFailCallback = TypedModelApiManager.defaultFailCallback): Promise<NestedModel> {
    return TypedModelApiManager.patch(`${DATA_ANALYSIS_ENDPOINT}/${id}`, JSON.stringify(data), override, onSuccessCallback, onFailCallback)
        .then((response) => {
            return response.json();
        });
  }
  ...
  // Human Reliability Analysis
  static patchHumanReliabilityLabel(id: number, data: LabelJSON, override: any = null, onSuccessCallback = TypedModelApiManager.defaultSuccessCallback, onFailCallback = TypedModelApiManager.defaultFailCallback): Promise<NestedModel> {
    return TypedModelApiManager.patch(`${HUMAN_RELIABILITY_ANALYSIS_ENDPOINT}/${id}`, JSON.stringify(data), override, onSuccessCallback, onFailCallback)
        .then((response) => {
            return response.json();
        });
  }
  ...
  // Systems Analysis
  static patchSystemsAnalysisLabel(id: number, data: LabelJSON, override: any = null, onSuccessCallback = TypedModelApiManager.defaultSuccessCallback, onFailCallback = TypedModelApiManager.defaultFailCallback): Promise<NestedModel> {
    return TypedModelApiManager.patch(`${SYSTEMS_ANALYSIS_ENDPOINT}/${id}`, JSON.stringify(data), override, onSuccessCallback, onFailCallback)
        .then((response) => {
            return response.json();
        });
  }
  ...
  // Success Criteria
  static patchSuccessCriteriaLabel(id: number, data: LabelJSON, override: any = null, onSuccessCallback = TypedModelApiManager.defaultSuccessCallback, onFailCallback = TypedModelApiManager.defaultFailCallback): Promise<NestedModel> {
    return TypedModelApiManager.patch(`${SUCCESS_CRITERIA_ENDPOINT}/${id}`, JSON.stringify(data), override, onSuccessCallback, onFailCallback)
        .then((response) => {
            return response.json();
        });
  }
  ...
  // Event Sequence Analysis
  static patchEventSequenceAnalysisLabel(id: number, data: LabelJSON, override: any = null, onSuccessCallback = TypedModelApiManager.defaultSuccessCallback, onFailCallback = TypedModelApiManager.defaultFailCallback): Promise<NestedModel> {
    return TypedModelApiManager.patch(`${EVENT_SEQUENCE_ANALYSIS_ENDPOINT}/${id}`, JSON.stringify(data), override, onSuccessCallback, onFailCallback)
        .then((response) => {
            return response.json();
        });
  }
  ...
  // Operating State Analysis
  static patchOperatingStateLabel(id: number, data: LabelJSON, override: any = null, onSuccessCallback = TypedModelApiManager.defaultSuccessCallback, onFailCallback = TypedModelApiManager.defaultFailCallback): Promise<NestedModel> {
    return TypedModelApiManager.patch(`${OPERATING_STATE_ANALYSIS_ENDPOINT}/${id}`, JSON.stringify(data), override, onSuccessCallback, onFailCallback)
        .then((response) => {
            return response.json();
        });
  }
  ...
  // Risk Integration
static async deleteRiskIntegration(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel> {
  const response = await NestedModelApiManager.delete(`${RISK_INTEGRATION_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback);
  const modelId = await TypedModelApiManager.getCurrentModelId();
  const body = {
      nestedId: id,
      nestedType: 'riskIntegration'
...
// Radiological Consequence Analysis
static async deleteRadiologicalConsequenceAnalysis(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel> {
  const response = await NestedModelApiManager.delete(`${RADIOLOGICAL_CONSEQUENCE_ANALYSIS_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback);
  const modelId = await TypedModelApiManager.getCurrentModelId();
  const body = {
      nestedId: id,
...
// Mechanistic Source Term
static async deleteMechanisticSourceTerm(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel> {
  const response = await NestedModelApiManager.delete(`${MECHANISTIC_SOURCE_TERM_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback);
  const modelId = await TypedModelApiManager.getCurrentModelId();
  const body = {
      nestedId: id,
      nestedType: 'mechanisticSourceTerm'
...
// Event Sequence Quantification Diagram
static async deleteEventSequenceQuantificationDiagram(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel> {
  const response = await NestedModelApiManager.delete(`${EVENT_SEQUENCE_QUANTIFICATION_DIAGRAM_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback);
  const modelId = await TypedModelApiManager.getCurrentModelId();
  const body = {
      nestedId: id,
      nestedType: 'eventSequenceQuantificationDiagram'
...
// Data Analysis
static async deleteDataAnalysis(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel> {
  const response = await NestedModelApiManager.delete(`${DATA_ANALYSIS_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback);
  const modelId = await TypedModelApiManager.getCurrentModelId();
  const body = {
      nestedId: id,
      nestedType: 'dataAnalysis'
...
// Human Reliability Analysis
static async deleteHumanReliabilityAnalysis(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel> {
  const response = await NestedModelApiManager.delete(`${HUMAN_RELIABILITY_ANALYSIS_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback);
  const modelId = await TypedModelApiManager.getCurrentModelId();
  const body = {
      nestedId: id,
      nestedType: 'humanReliabilityAnalysis'
...
// Systems Analysis
static async deleteSystemsAnalysis(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel> {
  const response = await NestedModelApiManager.delete(`${SYSTEMS_ANALYSIS_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback);
  const modelId = await TypedModelApiManager.getCurrentModelId();
  const body = {
      nestedId: id,
      nestedType: 'systemsAnalysis'
...
// Success Criteria
static async deleteSuccessCriteria(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel> {
  const response = await NestedModelApiManager.delete(`${SUCCESS_CRITERIA_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback);
  const modelId = await TypedModelApiManager.getCurrentModelId();
  const body = {
      nestedId: id,
      nestedType: 'successCriteria'
...
// Event Sequence Analysis
static async deleteEventSequenceAnalysis(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel> {
  const response = await NestedModelApiManager.delete(`${EVENT_SEQUENCE_ANALYSIS_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback);
  const modelId = await TypedModelApiManager.getCurrentModelId();
  const body = {
      nestedId: id,
      nestedType: 'eventSequenceAnalysis'
...
// Operating State Analysis
static async deleteOperatingStateAnalysis(id = -1, override: any = null, onSuccessCallback = NestedModelApiManager.defaultSuccessCallback, onFailCallback = NestedModelApiManager.defaultFailCallback): Promise<NestedModel> {
  const response = await NestedModelApiManager.delete(`${OPERATING_STATE_ANALYSIS_ENDPOINT}/?id=${Number(id)}`, override, onSuccessCallback, onFailCallback);
  const modelId = await TypedModelApiManager.getCurrentModelId();
  const body = {
      nestedId: id,
      nestedType: 'operatingStateAnalysis'
