...
export default class TypedModelApiManager {
  ...
  static getInternalEvents(
    ...
    return this.get(
      `${INTERNAL_EVENTS_ENDPOINT}/?id=${Number(id)}`,
      override,
      onSuccessCallback,
      onFailCallback,
    )
      .then((response) => response.json() as InternalEventsModel[]) // Parse the response as JSON
      .catch((error) => {
  ...
  static getExternalHazards(
    ...
    return this.get(
      `${EXTERNAL_HAZARDS_ENDPOINT}/?id=${Number(id)}`,
      override,
      onSuccessCallback,
      onFailCallback,
    )
      .then((response) => response.json() as ExternalHazardsModel[]) // Parse the response as JSON
      .catch((error) => {
        console.error("Error fetching internal events:", error);
        throw error; // Re-throw the error to propagate it if needed
      });
  ...
  static getInternalHazards(
    ...
    return this.get(
      `${INTERNAL_HAZARDS_ENDPOINT}/?id=${Number(id)}`,
      override,
      onSuccessCallback,
      onFailCallback,
    )
  ...
  static getFullScopeModels(
    ...
    return this.get(
      `${FULL_SCOPE_ENDPOINT}/?id=${Number(id)}`,
      override,
      onSuccessCallback,
      onFailCallback,
    )
      .then((response) => response.json() as FullScopeModel[]) // Parse the response as JSON
      .catch((error) => {
        console.error("Error fetching internal events:", error);
        throw error; // Re-throw the error to propagate it if needed
      });
   ...
   */
  static postInternalEvent(
    data: Partial<TypedModelJSON>,
    override: any = null,
    onSuccessCallback = TypedModelApiManager.defaultSuccessCallback,
    onFailCallback = TypedModelApiManager.defaultFailCallback,
  ): Promise<TypedModel> {
    return TypedModelApiManager.post(
   ...
   */
  static async deleteInternalEvent(
    id = -1,
    override: any = null,
    onSuccessCallback = TypedModelApiManager.defaultSuccessCallback,
    onFailCallback = TypedModelApiManager.defaultFailCallback,
    ...
    const userId = ApiManager.getCurrentUser().user_id;
    return await TypedModelApiManager.delete(
   ...
   */
  static async deleteExternalHazard(
    id = -1,
    override: any = null,
    onSuccessCallback = TypedModelApiManager.defaultSuccessCallback,
    onFailCallback = TypedModelApiManager.defaultFailCallback,
   ...
   */
  static async deleteInternalHazard(
    id = -1,
    override: any = null,
    onSuccessCallback = TypedModelApiManager.defaultSuccessCallback,
    onFailCallback = TypedModelApiManager.defaultFailCallback,
   ...
   */
  static addNestedToInternalEvent(
    body: { modelId: number; nestedId: number; nestedType: string },
    override: any = null,
    onSuccessCallback = TypedModelApiManager.defaultSuccessCallback,
    onFailCallback = TypedModelApiManager.defaultFailCallback,
  ): Promise<InternalEventsModel> {
   ...
   * @returns a promise with the updated model
   */
  static addNestedToInternalHazard(
    body: { modelId: number; nestedId: number; nestedType: string },
    override: any = null,
    onSuccessCallback = TypedModelApiManager.defaultSuccessCallback,
    onFailCallback = TypedModelApiManager.defaultFailCallback,
   ...
   * @returns a promise with the updated model
   */
  static addNestedToExternalHazard(
    body: { modelId: number; nestedId: number; nestedType: string },
    override: any = null,
    onSuccessCallback = TypedModelApiManager.defaultSuccessCallback,
    onFailCallback = TypedModelApiManager.defaultFailCallback,
   ...
   * @returns a promise with the updated model
   */
  static deleteNestedFromInternalEvent(
    modelId: number,
   ...
   * @returns a promise with the updated model
   */
  static deleteNestedFromInternalHazard(
    modelId: number,
    body: { nestedId: number; nestedType: string },
    override: any = null,
    onSuccessCallback = TypedModelApiManager.defaultSuccessCallback,
   ...
   * @returns a promise with the updated model
   */
  static deleteNestedFromExternalHazard(
    modelId: number,
    body: { nestedId: number; nestedType: string },
    override: any = null,
    onSuccessCallback = TypedModelApiManager.defaultSuccessCallback,
   ...
   * @returns a promise with the updated model
   */
  static deleteNestedFromFullScope(
    modelId: number,
    body: { nestedId: number; nestedType: string },
    override: any = null,
    onSuccessCallback = TypedModelApiManager.defaultSuccessCallback,
