...
export class NestedModelController {
  ...
  async createBayesianNetwork(
    @Body()
    body:
      | { data: Partial<NestedModel>; typedModel: TypedModelType }
      | Partial<NestedModel>,
  ): Promise<NestedModel> {
    const hasTypedModel = (
      v: unknown,
    ): v is { data: Partial<NestedModel>; typedModel: TypedModelType } =>
      typeof v === 'object' &&
      v !== null &&
      'typedModel' in (v as Record<string, unknown>);
    if (hasTypedModel(body)) {
      return this.bayesianNetworkService.createBayesianNetwork(
        body.data,
        body.typedModel,
      );
    }
    return this.nestedModelService.createBayesianNetwork(
      body as Partial<NestedModel>,
    );
  }
  ...
  async createEventSequenceDiagram(
    ...
    const hasTypedModel = (
      ...
      'typedModel' in (v as Record<string, unknown>);
    if (hasTypedModel(body)) {
      return this.eventSequenceDiagramService.createEventSequenceDiagram(
        body.data,
        body.typedModel,
      );
    }
    return this.nestedModelService.createEventSequenceDiagram(
      body as Partial<NestedModel>,
    );
  }
  ...
  async createEventTree(
    ...
    return this.nestedModelService.createEventTree(
      body as Partial<NestedModel>,
    );
  }
  ...
  async createFaultTree(
    ...
    return this.nestedModelService.createFaultTree(
      body as Partial<NestedModel>,
    );
  }
  ...
  async createInitiatingEvent(
    ...
    return this.nestedModelService.createInitiatingEvent(
      body as Partial<NestedModel>,
    );
  }
  ...
  async createEventSequenceAnalysis(
    ...
    const hasTypedModel = (
      ...
      'typedModel' in (v as Record<string, unknown>);
    if (hasTypedModel(body)) {
      return this.eventSequenceAnalysisService.createEventSequenceAnalysis(
        body.data,
        body.typedModel,
      );
    }
    return this.nestedModelService.createEventSequenceAnalysis(
      body as Partial<NestedModel>,
    );
  }
  ...
  async getEventSequenceDiagrams(
    ...
    if (typeof id === 'number') {
      ...
      return this.eventSequenceDiagramService.getEventSequenceDiagramsString(
        id,
      );
    }
  }
  ...
  async getEventSequenceAnalysis(
    ...
    if (typeof id === 'number') {
      ...
      return this.eventSequenceAnalysisService.getEventSequenceAnalysisString(
        id,
      );
    }
  }
  ...
  async getSingleBayesianNetwork(
    ...
    if (typeof modelId === 'number') {
      // Use core service for numeric IDs to match test expectations of persisted docs
      return this.nestedModelService.getSingleBayesianNetwork(
        modelId as number,
      );
    } else {
      return this.bayesianNetworkService.getSingleBayesianNetworkString(
        modelId,
      );
    }
  }
  ...
  async getSingleEventSequenceDiagram(
    ...
    if (typeof modelId === 'number') {
      // Use core service for numeric IDs to match test expectations of persisted docs
      return this.nestedModelService.getSingleEventSequenceDiagram(
        modelId as number,
      );
    } else {
      return this.eventSequenceDiagramService.getSingleEventSequenceDiagramString(
        modelId,
      );
    }
  }
  ...
  async getSingleInitiatingEvent(
    ...
    if (typeof modelId === 'number') {
      // Use core service for numeric IDs to match test expectations of persisted docs
      return this.nestedModelService.getSingleInitiatingEvent(
        modelId as number,
      );
    } else {
  ...
  async getSingleEventSequenceAnalysis(
    ...
    if (typeof modelId === 'number') {
      // Use core service for numeric IDs to match test expectations of persisted docs
      return this.nestedModelService.getSingleEventSequenceAnalysis(
        modelId as number,
      );
    } else {
      return this.eventSequenceAnalysisService.getSingleEventSequenceAnalysisString(
  ...
  async deleteBayesianNetwork(
    ...
    await this.bayesianNetworkService.deleteBayesianNetwork(
      id,
      typedModel as TypedModelType,
    );
  }
  ...
  async deleteEventSequenceDiagram(
    ...
    await this.eventSequenceDiagramService.deleteEventSequenceDiagram(
      id,
      typedModel as TypedModelType,
    );
  }
  ...
  async deleteEventTree(
    ...
    await this.eventTreeService.deleteEventTree(
      id,
      typedModel as TypedModelType,
    );
  }
  ...
  async deleteFaultTree(
    ...
    await this.faultTreesService.deleteFaultTree(
      id,
      typedModel as TypedModelType,
    );
  }
  ...
  async deleteInitiatingEvent(
    ...
    await this.initiatingEventsService.deleteInitiatingEvent(
      id,
      typedModel as TypedModelType,
    );
  }
  ...
  async deleteEventSequenceAnalysis(
    ...
    return this.eventSequenceAnalysisService.deleteEventSequenceAnalysis(
      id,
      typedModel as TypedModelType,
    );
  }
  ...
  async updateBayesianNetworkLabel(
    ...
    if (typeof id === 'number')
      return this.nestedModelService.updateBayesianNetworkLabelNumber(id, data);
  ...
  async updateEventSequenceDiagramLabel(
    ...
    if (typeof id === 'number')
      return this.nestedModelService.updateEventSequenceDiagramLabelNumber(
        id,
        data,
      );
    return this.eventSequenceDiagramService.updateEventSequenceDiagramLabel(
      id,
      data,
    );
  }
  ...
  async updateEventTreeLabel(
    ...
    if (typeof id === 'number')
      return this.nestedModelService.updateEventTreeLabelNumber(id, data);
  ...
  async updateFaultTreeLabel(
    ...
    if (typeof id === 'number')
      return this.nestedModelService.updateFaultTreeLabelNumber(id, data);
  ...
  async updateInitiatingEventLabel(
    ...
    if (typeof id === 'number')
      return this.nestedModelService.updateInitiatingEventLabelNumber(id, data);
  ...
  async updateEventSequenceAnalysisLabel(
    ...
    if (typeof id === 'number')
      return this.nestedModelService.updateEventSequenceAnalysisLabelNumber(
        id,
        data,
      );
    return this.eventSequenceAnalysisService.updateEventSequenceAnalysisLabel(
      id,
      data,
    );
  }
   ...
   */
  @Delete()
  async removeParentIds(
    @Query('id') modelId: number | string,
  ): Promise<number> {
