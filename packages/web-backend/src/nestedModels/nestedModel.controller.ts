...
export class NestedModelController {
  ...
  async createComponentParameter(
    ...
    @Body()
    body: CreateComponentParameterDto,
  ...
  async updateComponentParameter(
    ...
    paramId: number,
    @Body()
    body: UpdateComponentParameterDto,
  ): Promise<ComponentParameter> {
