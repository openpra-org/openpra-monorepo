...
describe("CollabService", () => {
  ...
  describe("Bayesian Estimation", () => {
    describe("createBayesianEstimation", () => {
      ...
      it("should create bayesian estimation without parent ids", async () => {
        let bayesianEstimationObject = {
          label: {
            name: "testBayesianEstimation",
            description: "test description",
          },
        };
        let res = await nestedModelService.createBayesianEstimation(
          bayesianEstimationObject,
        );
        ...
        expect(res.label.description).toBe(
          bayesianEstimationObject.label.description,
        );
      });
      ...
      it("IDs should be incremented", async () => {
        let bayesianEstimationObject1 = {
          label: {
            name: "testBayesianEstimation1",
            description: "test description",
          },
          parentIds: [],
        };
        let res1 = await nestedModelService.createBayesianEstimation(
          bayesianEstimationObject1,
        );
        let bayesianEstimationObject2 = {
          label: {
        ...
        let res2 = await nestedModelService.createBayesianEstimation(
    ...
    describe("getSingleBayesianEstimations", () => {
      ...
      it("should return correct object", async () => {
        const bayesianEstimationObject = {'label':{'name':'testBayesianEstimation','description':'test description'},'parentIds':[1,2]}
        const res = await nestedModelService.createBayesianEstimation(bayesianEstimationObject);
    ...
    describe("deleteBayesianEstimation", () => {
      ...
      it("should delete the Bayesian Estimation", async () => {
        const bayesianEstimationObject = {'label':{'name':'testBayesianEstimation','description':'test description'},'parentIds':[1,2]}
        const res = await nestedModelService.createBayesianEstimation(bayesianEstimationObject);
        const deletedBayesianEstimation = await nestedModelService.deleteBayesianEstimation(res.id);
        const returnedBayesianEstimation = await nestedModelService.getSingleBayesianEstimation(res.id);
        expect(returnedBayesianEstimation).toBeNull();
      });
  ...
  describe("Event Sequence Diagram", () => {
    describe("createEventSequenceDiagram", () => {
      ...
      it("should create event sequence diagram without parent ids", async () => {
        let eventSequenceDiagramObject = {
          label: { name: "testEventSequence", description: "test description" },
        };
        let res = await nestedModelService.createEventSequenceDiagram(
          eventSequenceDiagramObject,
        );
        expect(res).toBeDefined();
        expect(res.parentIds).toEqual([]);
        expect(res.label.name).toBe(eventSequenceDiagramObject.label.name);
        expect(res.label.description).toBe(
          eventSequenceDiagramObject.label.description,
        );
      });
      it("should create bayesian estimation with parent ids", async () => {
        let eventSequenceDiagramObject = {
      ...
      it("IDs should be incremented", async () => {
        let eventSequenceDiagramObject1 = {
          label: { name: "testEventSequence", description: "test description" },
        };
        let res1 = await nestedModelService.createEventSequenceDiagram(
          eventSequenceDiagramObject1,
        );
        let eventSequenceDiagramObject2 = {
          label: { name: "testEventSequence", description: "test description" },
        };
        let res2 = await nestedModelService.createEventSequenceDiagram(
  ...
  describe("Event Tree", () => {
    describe("createEventTree", () => {
      ...
      it("should create Event Tree without parent ids", async () => {
        const eventTreeObject = {'label':{'name':'testEventTree','description':'test description'}}
        };
        const res = await nestedModelService.createEventTree(eventTreeObject);
        expect(res).toBeDefined();
        expect(res.parentIds).toEqual([]);
      ...
      it("should create Event Tree with parent ids", async () => {
        let eventTreeObject = {
          label: { name: "testEventTree", description: "test description" },
          parentIds: [2, 3],
        };
        let res =
          await nestedModelService.createEventSequenceDiagram(eventTreeObject);
        expect(res).toBeDefined();
        expect(res.parentIds).toEqual(eventTreeObject.parentIds);
      });

      it("IDs should be incremented", async () => {
        let eventTreeObject1 = {
          label: { name: "testEventTree", description: "test description" },
        };
        let res1 =
          await nestedModelService.createEventSequenceDiagram(eventTreeObject1);
        let eventTreeObject2 = {
          label: { name: "testEventSequence", description: "test description" },
        };
        let res2 =
  ...
  describe("Fault Tree", () => {
    describe("createFaultTree", () => {
      ...
      it("should create Fault Tree without parent ids", async () => {
        let faultTreeObject = {
          label: { name: "testFaultTree", description: "test description" },
        };
        const res = await nestedModelService.createFaultTree(faultTreeObject);
        expect(res).toBeDefined();
        expect(res.parentIds).toEqual([]);
      ...
      it("should create bayesian estimation with parent ids", async () => {
        ...
        let res =
          await nestedModelService.createEventSequenceDiagram(faultTreeObject);
        expect(res).toBeDefined();
        expect(res.parentIds).toEqual(faultTreeObject.parentIds);
      });

      it("IDs should be incremented", async () => {
        let faultTreeObject1 = {
          label: { name: "testFaultTree", description: "test description" },
        };
        let res1 =
          await nestedModelService.createEventSequenceDiagram(faultTreeObject1);
        let faultTreeObject2 = {
          label: { name: "testFaultTree", description: "test description" },
        };
        let res2 =
  ...
  describe("Radiological Consequence Analysis", () => {
    ...
    describe("getRadiologicalConsequenceAnalysis", () => {
      it("should be defined", () => {
        expect(
          nestedModelService.getRadiologicalConsequenceAnalysis,
        ).toBeDefined();
      });
    });
  });
  ...
  describe("Event Sequence Quantification Diagram", () => {
    ...
    describe("getEventSequenceQuantificationDiagram", () => {
      it("should be defined", () => {
        expect(
          nestedModelService.getEventSequenceQuantificationDiagram,
        ).toBeDefined();
      });
    });
  });
