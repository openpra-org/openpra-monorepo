...
describe("CollabService", () => {
  ...
  describe("Bayesian Estimation", () => {
    describe("createBayesianEstimation", () => {
      ...
      it("IDs should be incremented", async () => {
        ...
        const res2 = await nestedModelService.createBayesianEstimation(bayesianEstimationObject2);
    ...
    describe("deleteBayesianEstimation", () => {
      ...
      it("should return null for when Bayesian Estimation not present", async () => {
        const deletedBayesianEstimation = await nestedModelService.deleteBayesianEstimation(0);
  ...
  describe("Functional Events", () => {
    describe("createFunctionalEvent", () => {
      ...
      it("IDs should be incremented", async () => {
        const res1 = await nestedModelService.createFunctionalEvent(createFunctionalEventObject);
        ...
        const res2 = await nestedModelService.createFunctionalEvent(functionalEventObject2);
        expect(res1.id).toEqual(res2.id - 1);
      });
    });
    describe("getSingleFunctionalEvent", () => {
      ...
      it("should return correct object", async () => {
        const res = await nestedModelService.createFunctionalEvent(createFunctionalEventObject);
        const returnedFunctionalEvent = await nestedModelService.getSingleFunctionalEvent(res.id);
  ...
  describe("Initiating Events", () => {
    describe("createInitiatingEvent", () => {
      ...
      it("should create Initiating Event without parent ids", async () => {
        const res = await nestedModelService.createInitiatingEvent(createInitiatingEventObject);
        expect(res).toBeDefined();
        expect(res.parentIds).toEqual([]);
        expect(res.label.name).toBe(createInitiatingEventObject.label.name);
        expect(res.label.description).toBe(createInitiatingEventObject.label.description);
      });
      ...
      it("IDs should be incremented", async () => {
        const res1 = await nestedModelService.createInitiatingEvent(createInitiatingEventObject);
        ...
        const res2 = await nestedModelService.createInitiatingEvent(initiatingEventObject2);
        expect(res1.id).toEqual(res2.id - 1);
      });
    });
    describe("getSingleInitiatingEvent", () => {
      ...
      it("should return null if ID not present", async () => {
        const returnedInitiatingEvent = await nestedModelService.getSingleInitiatingEvent(0);
        expect(returnedInitiatingEvent).toBeNull();
      });
      it("should return correct object", async () => {
        const res = await nestedModelService.createInitiatingEvent(createInitiatingEventObject);
        const returnedInitiatingEvent = await nestedModelService.getSingleInitiatingEvent(res.id);
  ...
  describe("Markov Chain", () => {
    describe("createMarkovChain", () => {
      ...
      it("IDs should be incremented", async () => {
        const res1 = await nestedModelService.createMarkovChain(createMarkovChainObject);
        const markovChainObject2 = {
          label: { name: "testMarkovChain", description: "test description" },
        };
        const res2 = await nestedModelService.createMarkovChain(markovChainObject2);
        expect(res1.id).toEqual(res2.id - 1);
      });
    });
    describe("getSingleMarkovChain", () => {
      ...
      it("should return correct object", async () => {
        const res = await nestedModelService.createMarkovChain(createMarkovChainObject);
        const returnedMarkovChain = await nestedModelService.getSingleMarkovChain(res.id);
  ...
  describe("Weibull analysis", () => {
    describe("createWeibullAnalysis", () => {
      ...
      it("IDs should be incremented", async () => {
        const res1 = await nestedModelService.createWeibullAnalysis(createWeibullAnalysisObject);
        ...
        const res2 = await nestedModelService.createWeibullAnalysis(weibullAnalysisObject2);
        expect(res1.id).toEqual(res2.id - 1);
      });
    });
    ...
    describe("getSingleWeibullAnalysis", () => {
      ...
      it("should return correct object", async () => {
        const res = await nestedModelService.createWeibullAnalysis(createWeibullAnalysisObject);
        const returnedWeibullAnalysis = await nestedModelService.getSingleWeibullAnalysis(res.id);
  ...
  describe("Risk Integration", () => {
    describe("createRiskIntegration", () => {
      ...
      it("IDs should be incremented", async () => {
        const res1 = await nestedModelService.createRiskIntegration(createRiskIntegrationObject);
        ...
        const res2 = await nestedModelService.createRiskIntegration(riskIntegrationObject2);
        expect(res1.id).toEqual(res2.id - 1);
      });
    });
    describe("getSingleRiskIntegration", () => {
      ...
      it("should return correct object", async () => {
        const res = await nestedModelService.createRiskIntegration(createRiskIntegrationObject);
        const returnedRiskIntegration = await nestedModelService.getSingleRiskIntegration(res.id);
  ...
  describe("Radiological Consequence Analysis", () => {
    describe("createRadiologicalConsequenceAnalysis", () => {
      ...
      it("should create Radiological Consequence Analysis with parent ids", async () => {
        ...
        expect(res).toBeDefined();
        expect(res.parentIds).toEqual(createRadiologicalConsequenceAnalysisObject.parentIds);
    ...
    describe("getSingleRadiologicalConsequenceAnalysis", () => {
      ...
      it("should return correct object", async () => {
        ...
        const returnedRadiologicalConsequenceAnalysis =
          await nestedModelService.getSingleRadiologicalConsequenceAnalysis(res.id);
  ...
  describe("Mechanistic Source Term", () => {
    describe("createMechanisticSourceTerm", () => {
      ...
      it("should create Mechanistic Source Term with parent ids", async () => {
        ...
        const res = await nestedModelService.createMechanisticSourceTerm(createMechanisticSourceTermObject);
        expect(res).toBeDefined();
        expect(res.parentIds).toEqual(createMechanisticSourceTermObject.parentIds);
    ...
    describe("getSingleMechanisticSourceTerm", () => {
      ...
      it("should return correct object", async () => {
        const res = await nestedModelService.createMechanisticSourceTerm(createMechanisticSourceTermObject);
        const returnedMechanisticSourceTerm = await nestedModelService.getSingleMechanisticSourceTerm(res.id);
  ...
  describe("Event Sequence Quantification Diagram", () => {
    describe("createEventSequenceQuantificationDiagram", () => {
      ...
      it("should create Event Sequence Quantification Diagram with parent ids", async () => {
        ...
        expect(res).toBeDefined();
        expect(res.parentIds).toEqual(createEventSequenceQuantificationDiagramObject.parentIds);
      ...
      it("IDs should be incremented", async () => {
        ...
        const res2 = await nestedModelService.createEventSequenceQuantificationDiagram(
    ...
    describe("getSingleEventSequenceQuantificationDiagram", () => {
      ...
      it("should return null if ID not present", async () => {
        const returnedEventSequenceQuantificationDiagram =
          await nestedModelService.getSingleEventSequenceQuantificationDiagram(0);
      ...
      it("should return correct object", async () => {
        ...
        const returnedEventSequenceQuantificationDiagram =
          await nestedModelService.getSingleEventSequenceQuantificationDiagram(res.id);
  ...
  describe("Data Analysis", () => {
    describe("createDataAnalysis", () => {
      ...
      it("IDs should be incremented", async () => {
        const res1 = await nestedModelService.createDataAnalysis(createDataAnalysisObject);
        const dataAnalysisObject2 = {
          label: { name: "testDataAnalysis", description: "test description" },
        };
        const res2 = await nestedModelService.createDataAnalysis(dataAnalysisObject2);
        expect(res1.id).toEqual(res2.id - 1);
      });
    });
    describe("getSingleDataAnalysis", () => {
      ...
      it("should return correct object", async () => {
        const res = await nestedModelService.createDataAnalysis(createDataAnalysisObject);
        const returnedDataAnalysis = await nestedModelService.getSingleDataAnalysis(res.id);
  ...
  describe("Human Reliability Analysis", () => {
    ...
    describe("createHumanReliabilityAnalysis", () => {
      ...
      it("should create Human Reliability Analysis with parent ids", async () => {
        ...
        const res = await nestedModelService.createHumanReliabilityAnalysis(createHumanReliabilityAnalysisObject);
        expect(res).toBeDefined();
        expect(res.parentIds).toEqual(createHumanReliabilityAnalysisObject.parentIds);
        delete createHumanReliabilityAnalysisObject.parentIds;
      });
      it("IDs should be incremented", async () => {
        const res1 = await nestedModelService.createHumanReliabilityAnalysis(createHumanReliabilityAnalysisObject);
        ...
        const res2 = await nestedModelService.createHumanReliabilityAnalysis(humanReliabilityAnalysisObject2);
        expect(res1.id).toEqual(res2.id - 1);
      });
    });
    ...
    describe("getSingleHumanReliabilityAnalysis", () => {
      ...
      it("should return correct object", async () => {
        const res = await nestedModelService.createHumanReliabilityAnalysis(createHumanReliabilityAnalysisObject);
        const returnedHumanReliabilityAnalysis = await nestedModelService.getSingleHumanReliabilityAnalysis(res.id);
  ...
  describe("Systems Analysis", () => {
    ...
    describe("getSingleSystemsAnalysis", () => {
      ...
      it("should return correct object", async () => {
        const res = await nestedModelService.createSystemsAnalysis(createSystemsAnalysisObject);
        const returnedSystemsAnalysis = await nestedModelService.getSingleSystemsAnalysis(res.id);
  ...
  describe("Success Criteria", () => {
    ...
    describe("getSingleSuccessCriteria", () => {
      ...
      it("should return correct object", async () => {
        const res = await nestedModelService.createSuccessCriteria(createSuccessCriteriaObject);
        const returnedSuccessCriteria = await nestedModelService.getSingleSuccessCriteria(res.id);
  ...
  describe("Event Sequence Analysis", () => {
    describe("createEventSequenceAnalysis", () => {
      ...
      it("should create Event Sequence Analysis without parent ids", async () => {
        const res = await nestedModelService.createEventSequenceAnalysis(createEventSequenceAnalysisObject);
        expect(res).toBeDefined();
        expect(res.parentIds).toEqual([]);
        expect(res.label.name).toBe(createEventSequenceAnalysisObject.label.name);
        expect(res.label.description).toBe(createEventSequenceAnalysisObject.label.description);
      });
      it("should create Event Sequence Analysis with parent ids", async () => {
        createEventSequenceAnalysisObject.parentIds = [2, 3];
        const res = await nestedModelService.createEventSequenceAnalysis(createEventSequenceAnalysisObject);
        expect(res).toBeDefined();
        expect(res.parentIds).toEqual(createEventSequenceAnalysisObject.parentIds);
        delete createEventSequenceAnalysisObject.parentIds;
      });
      it("IDs should be incremented", async () => {
        const res1 = await nestedModelService.createEventSequenceAnalysis(createEventSequenceAnalysisObject);
        const eventSequenceAnalysisObject2 = {
          label: { name: "testEventSequence", description: "test description" },
        };
        const res2 = await nestedModelService.createEventSequenceAnalysis(eventSequenceAnalysisObject2);
        expect(res1.id).toEqual(res2.id - 1);
      });
    });
    ...
    describe("getSingleEventSequenceAnalysis", () => {
      ...
      it("should return null if ID not present", async () => {
        const returnedEventSequenceAnalysis = await nestedModelService.getSingleEventSequenceAnalysis(0);
        expect(returnedEventSequenceAnalysis).toBeNull();
      });
      it("should return correct object", async () => {
        const res = await nestedModelService.createEventSequenceAnalysis(createEventSequenceAnalysisObject);
        const returnedEventSequenceAnalysis = await nestedModelService.getSingleEventSequenceAnalysis(res.id);
  ...
  describe("Operating State Analysis", () => {
    describe("createOperatingStateAnalysis", () => {
      ...
      it("should create Operating State Analysis with parent ids", async () => {
        ...
        const res = await nestedModelService.createOperatingStateAnalysis(createOperatingStateAnalysisObject);
        expect(res).toBeDefined();
        expect(res.parentIds).toEqual(createOperatingStateAnalysisObject.parentIds);
        delete createOperatingStateAnalysisObject.parentIds;
      });
      it("IDs should be incremented", async () => {
        const res1 = await nestedModelService.createOperatingStateAnalysis(createOperatingStateAnalysisObject);
        ...
        const res2 = await nestedModelService.createOperatingStateAnalysis(operatingStateAnalysisObject2);
        expect(res1.id).toEqual(res2.id - 1);
      });
    });
    ...
    describe("getSingleOperatingStateAnalysis", () => {
      ...
      it("should return correct object", async () => {
        const res = await nestedModelService.createOperatingStateAnalysis(createOperatingStateAnalysisObject);
        const returnedOperatingStateAnalysis = await nestedModelService.getSingleOperatingStateAnalysis(res.id);
