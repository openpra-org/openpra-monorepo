...
describe("TypedModel Controller", () => {
      ...
      providers: [
        {
          ...
          useValue: {
            createInternalEventModel: jest
              .fn()
              .mockResolvedValue(createInternalEventResponse),
            createInternalHazardModel: jest
              .fn()
              .mockResolvedValue(createInternalHazardResponse),
            createExternalHazardModel: jest
              .fn()
              .mockResolvedValue(createExternalHazardResponse),
            createFullScopeModel: jest
              .fn()
              .mockResolvedValue(createFullScopeResponse),
            patchInternalEvent: jest
              .fn()
              .mockResolvedValue(updateInternalEventResponse),
            patchInternalHazard: jest
              .fn()
              .mockResolvedValue(updateInternalHazardResponse),
            patchExternalHazard: jest
              .fn()
              .mockResolvedValue(updateExternalHazardResponse),
            patchFullScope: jest
              .fn()
              .mockResolvedValue(updateFullScopeResponse),
            ...
            deleteInternalEvent: jest
              .fn()
              .mockResolvedValue(HttpStatus.NO_CONTENT),
            deleteInternalHazard: jest
              .fn()
              .mockResolvedValue(HttpStatus.NO_CONTENT),
            deleteExternalHazard: jest
              .fn()
              .mockResolvedValue(HttpStatus.NO_CONTENT),
            deleteFullScope: jest.fn().mockResolvedValue(HttpStatus.NO_CONTENT),
            addNestedToInternalEvent: jest
              .fn()
              .mockResolvedValue(addNestedToInternalEventResponse),
            addNestedToInternalHazard: jest
              .fn()
              .mockResolvedValue(addNestedToInternalHazardResponse),
            addNestedToExternalHazard: jest
              .fn()
              .mockResolvedValue(addNestedToExternalHazardResponse),
            addNestedToFullScope: jest
              .fn()
              .mockResolvedValue(addNestedToFullScopeResponse),
            deleteNestedFromInternalEvent: jest
              .fn()
              .mockResolvedValue(updateInternalEventResponse),
            deleteNestedFromInternalHazard: jest
              .fn()
              .mockResolvedValue(updateInternalHazardResponse),
            deleteNestedFromExternalHazard: jest
              .fn()
              .mockResolvedValue(updateExternalHazardResponse),
            deleteNestedFromFullScope: jest
              .fn()
              .mockResolvedValue(updateFullScopeResponse),
          },
        },
  ...
  describe("createInternalEvent()", () => {
    it("Should return the newly created Internal Event Model", () => {
      expect(
        Controller.createInternalEvent(createInternalEventRequest),
      ).resolves.toEqual(createInternalEventResponse);
    });
  });
  ...
  describe("createInternalHazard()", () => {
    it("Should return the newly created Internal Hazard Model", () => {
      expect(
        Controller.createInternalHazard(createInternalHazardRequest),
      ).resolves.toEqual(createInternalHazardResponse);
    });
  });
  ...
  describe("createExternalHazard()", () => {
    it("Should return the newly created External Hazard Model", () => {
      expect(
        Controller.createExternalHazard(createExternalHazardRequest),
      ).resolves.toEqual(createExternalHazardResponse);
    });
  });
  ...
  describe("createFullScope()", () => {
    it("Should return the newly created Full Scope Model", () => {
      expect(
        Controller.createFullScope(createFullScopeRequest),
      ).resolves.toEqual(createFullScopeResponse);
    });
  });
  ...
  describe("patchInternalEvent()", () => {
    it("Should return the updated Internal Event Model", () => {
      expect(
        Controller.patchInternalEvent(request, "1", updateInternalEventRequest),
      ).resolves.toEqual(updateInternalEventResponse);
    });
  });
  ...
  describe("patchInternalHazard()", () => {
    it("Should return the updated Internal Hazard Model", () => {
      expect(
        Controller.patchInternalHazard(
          request,
          "2",
          updateInternalHazardRequest,
        ),
      ).resolves.toEqual(updateInternalHazardResponse);
    });
  });
  ...
  describe("patchExternalHazard()", () => {
    it("Should return the updated External Hazard Model", () => {
      expect(
        Controller.patchExternalHazard(
          request,
          "3",
          updateExternalHazardRequest,
        ),
      ).resolves.toEqual(updateExternalHazardResponse);
    });
  });
  ...
  describe("patchFullScope()", () => {
    it("Should return the updated Full Scope Model", () => {
      expect(
        Controller.patchFullScope(request, "4", updateFullScopeRequest),
      ).resolves.toEqual(updateFullScopeResponse);
    });
  });

  describe("getInternalEvents()", () => {
    it("Should return the list of Internal Event Models", () => {
      expect(Controller.getInternalEvents(request)).resolves.toEqual(
        getInternalEvents,
      );
    });
  });
  ...
  describe("getInternalHazards", () => {
    it("Should return the list of Internal Hazard Models", () => {
      expect(Controller.getInternalHazards(request)).resolves.toEqual(
        getInternalHazards,
      );
    });
  });
  ...
  describe("getExternalHazards()", () => {
    it("Should return the list of External Hazard Models", () => {
      expect(Controller.getExternalHazards(request)).resolves.toEqual(
        getExternalHazards,
      );
    });
  });
  ...
  describe("getInternalEvent()", () => {
    it("Should return an Internal Event Model", () => {
      expect(Controller.getInternalEvent(request, "5")).resolves.toEqual(
        getInternalEvent,
      );
    });
  });
  ...
  describe("getInternalHazard()", () => {
    it("Should return an Internal Hazard Model", () => {
      expect(Controller.getInternalHazard(request, "6")).resolves.toEqual(
        getInternalHazard,
      );
    });
  });
  ...
  describe("getExternalHazard()", () => {
    it("Should return an External Hazard Model", () => {
      expect(Controller.getExternalHazard(request, "7")).resolves.toEqual(
        getExternalHazard,
      );
    });
  });
  ...
  describe("getFullScope()", () => {
    it("Should return a Full Scope Model", () => {
      expect(Controller.getFullScope(request, "8")).resolves.toEqual(
        getFullScope,
      );
    });
  });
  ...
  describe("deleteInternalEvent()", () => {
    it("Should delete the Internal Event Model and return 204 status", () => {
      expect(Controller.deleteInternalEvent(request, "5")).resolves.toEqual(
  ...
  describe("deleteInternalHazard()", () => {
    it("Should delete the Internal Hazard Model and return 204 status", () => {
      expect(Controller.deleteInternalHazard(request, "6")).resolves.toEqual(
        HttpStatus.NO_CONTENT,
      );
    });
  });
  ...
  describe("deleteExternalHazard()", () => {
    it("Should delete the External Hazard Model and return 204 status", () => {
      expect(Controller.deleteExternalHazard(request, "7")).resolves.toEqual(
        HttpStatus.NO_CONTENT,
      );
    });
  });
  ...
  describe("deleteFullScope()", () => {
    it("Should delete the Full Scope Model and return 204 status", () => {
      expect(Controller.deleteFullScope(request, "8")).resolves.toEqual(
        HttpStatus.NO_CONTENT,
      );
    });
  });
  ...
  describe("addNestedToInternalEvent()", () => {
    it("Should return the Updated Internal Event Model including the Nested Model", () => {
      expect(
        Controller.addNestedToInternalEvent(addNestedToInternalEventRequest),
      ).resolves.toEqual(addNestedToInternalEventResponse);
    });
  });
  ...
  describe("addNestedToInternalHazard()", () => {
    it("Should return the Updated Internal Hazard Model including the Nested Model", () => {
      expect(
        Controller.addNestedToInternalHazard(addNestedToInternalHazardRequest),
      ).resolves.toEqual(addNestedToInternalHazardResponse);
    });
  });
  ...
  describe("addNestedToExternalHazard()", () => {
    it("Should return the Updated External Hazard Model including the Nested Model", () => {
      expect(
        Controller.addNestedToExternalHazard(addNestedToExternalHazardRequest),
      ).resolves.toEqual(addNestedToExternalHazardResponse);
    });
  });
  ...
  describe("addNestedToFullScope()", () => {
    it("Should return the Updated Full Scope Model including the Nested Model", () => {
      expect(
        Controller.addNestedToFullScope(addNestedToFullScopeRequest),
      ).resolves.toEqual(addNestedToFullScopeResponse);
    });
  });
  ...
  describe("deleteNestedFromInternalEvent()", () => {
    it("Should return the Updated Internal Event Model excluding the Nested Model", () => {
      expect(
        Controller.deleteNestedFromInternalEvent(
          "1",
          deleteNestedFromInternalEventRequest,
        ),
      ).resolves.toEqual(updateInternalEventResponse);
    });
  });
  ...
  describe("deleteNestedFromInternalHazard()", () => {
    it("Should return the Updated Internal Hazard Model excluding the Nested Model", () => {
      expect(
        Controller.deleteNestedFromInternalHazard(
          "2",
          deleteNestedFromInternalHazardRequest,
        ),
      ).resolves.toEqual(updateInternalHazardResponse);
    });
  });
  ...
  describe("deleteNestedFromExternalHazard()", () => {
    it("Should return the Updated External Hazard Model excluding the Nested Model", () => {
      expect(
        Controller.deleteNestedFromExternalHazard(
          "3",
          deleteNestedFromExternalHazardRequest,
        ),
      ).resolves.toEqual(updateExternalHazardResponse);
    });
  });
  ...
  describe("deleteNestedFromFullScope()", () => {
    it("Should return the Updated Full Scope Model excluding the Nested Model", () => {
      expect(
        Controller.deleteNestedFromFullScope(
          "4",
          deleteNestedFromFullScopeRequest,
        ),
      ).resolves.toEqual(updateFullScopeResponse);
    });
  });
