...
import { ModelCounter, ModelCounterDocument } from 'src/hcl/schemas/model-counter.schema';
...
import { ActionDocument } from 'src/hcl/schemas/action.schema';
import { BayesianNetworks, BayesianNetworksDocument } from 'src/hcl/schemas/bayesian-networks.schema';
import { EventSequenceDiagram, EventSequenceDiagramDocument } from 'src/hcl/schemas/event-sequence-diagram.schema';
import { FaultTree, FaultTreeDocument } from 'src/hcl/schemas/fault-tree.schema';
import { GlobalParameterCounter, GlobalParameterCounterDocument } from 'src/hcl/schemas/global-parameter-counter.schema';
import { GlobalParameter, GlobalParameterDocument } from 'src/hcl/schemas/global-parameter.schema';
import { HclModelTree, HclModelTreeDocument } from 'src/hcl/schemas/hcl-model-tree.schema';
import { HclModel, HclModelDocument } from 'src/hcl/schemas/hcl-model.schema';
import { OverviewTree, OverviewTreeDocument } from 'src/hcl/schemas/overview-tree.schema';
import { QuantificationResultCounter, QuantificationResultCounterDocument } from 'src/hcl/schemas/quantification-result-counter.schema';
import { QuantificationResult, QuantificationResultDocument } from 'src/hcl/schemas/quantification-result.schema';
import { TreeCounter, TreeCounterDocument } from 'src/hcl/schemas/tree-counter.schema';
...
export class TypedModelService {
  ...
  */
  async createInternalEventsModel(body: InternalEventsModel): Promise<InternalEventsModel> {
    const model = body
