...
TARGET_TS = "packages/quantum-readiness/src/lib/openpra-quantum-frontend-subtree-detail-payload.ts"
TARGET_SPEC = "packages/quantum-readiness/src/lib/openpra-quantum-frontend-subtree-detail-payload.spec.ts"
INDEX_TS = "packages/quantum-readiness/src/lib/index.ts"
...
EXPORT_LINE = 'export * from "./lib/openpra-quantum-frontend-subtree-detail-payload";\n'
...
def write_file(relative_path: str, content: str) -> None:
    ...
    target_path.write_text(norm(content), encoding="utf-8")


def ensure_export_line() -> None:
    index_path = REPO_ROOT / INDEX_TS
...
def main() -> None:
    write_file(TARGET_TS, TARGET_TS_CONTENT)
    write_file(TARGET_SPEC, TARGET_SPEC_CONTENT)
    ensure_export_line()
    print("Applied frontend subtree detail payload chunk Q fix successfully.")
