...
SCRIPT_VERSION = "openpra-quantum-expand-real-case-validation-v1"
...
SEED_DIR = REPO_ROOT / "_work" / "openpra_quantum_simulator_validation_v1_real_clean"
OUT_DIR = REPO_ROOT / "_work" / "openpra_quantum_simulator_validation_v1_real_expanded"
PREP_ROOT = REPO_ROOT / "_work" / "openpra_quantum_real_preparation_v1_expanded"
PROBE_ROOT = REPO_ROOT / "_work" / "openpra_quantum_real_preparation_probe_v1"
ROLLUP_OUT = OUT_DIR / "_rollup"
SUMMARY_DIR = REPO_ROOT / "_work" / "openpra_quantum_real_case_expansion_v1"
...
def main() -> None:
    ...
    summary_path = SUMMARY_DIR / "openpra_quantum_real_case_expansion_summary_v1.json"
    write_json(summary_path, summary)

    memo_lines = [
        "OpenPRA Quantum Real Case Expansion Summary v1",
        "",
    ...
    memo_path = SUMMARY_DIR / "OPENPRA_QUANTUM_REAL_CASE_EXPANSION_MEMO_v1.txt"
