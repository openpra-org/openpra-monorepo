...
WORK_ROOT="${REPO_ROOT}/_work/openpra_phase3_core5_dump_v1"
STAMP="$(date -u +%Y%m%d_%H%M%SZ)"
RUN_DIR="${WORK_ROOT}/${STAMP}"
FILES_DIR="${RUN_DIR}/files"
COMBINED="${RUN_DIR}/OPENPRA_PHASE3_CORE5_FULL_FILE_DUMP.txt"
...
{
  echo "OPENPRA PHASE 3 CORE 5 FULL FILE DUMP"
